		...
		private sealed class _003CAnimateVertexColors_003Ed__11 : IEnumerator<object>, IEnumerator, IDisposable
		{
			...
			private bool MoveNext()
			{
				...
				case 0:
					...
					_003CtextInfo_003E5__2 = vertexShakeA.m_TextComponent.textInfo;
				...
				for (int j = 0; j < lineCount; j++)
				{
					...
					for (int k = firstCharacterIndex; k <= lastCharacterIndex; k++)
					{
						if (_003CtextInfo_003E5__2.characterInfo[k].isVisible)
						{
							...
							_003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex] = vertices[vertexIndex] - vector;
							_003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 1] = vertices[vertexIndex + 1] - vector;
							_003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 2] = vertices[vertexIndex + 2] - vector;
							_003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 3] = vertices[vertexIndex + 3] - vector;
				...
				for (int l = 0; l < _003CtextInfo_003E5__2.meshInfo.Length; l++)
				{
					...
					vertexShakeA.m_TextComponent.UpdateGeometry(_003CtextInfo_003E5__2.meshInfo[l].mesh, l);
				}
