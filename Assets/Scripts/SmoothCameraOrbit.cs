...
public class SmoothCameraOrbit : MonoBehaviour
{
	...
	private void LateUpdate()
	{
		...
		{
			desiredDistance -= UnityEngine.Input.GetAxis("Mouse Y") * 0.02f * (float)zoomRate * 0.125f * Mathf.Abs(desiredDistance);
		}
		...
		desiredDistance -= UnityEngine.Input.GetAxis("Mouse ScrollWheel") * 0.02f * (float)zoomRate * Mathf.Abs(desiredDistance);
