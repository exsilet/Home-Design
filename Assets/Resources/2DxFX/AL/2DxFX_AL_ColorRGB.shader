  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord3.xyz) + float3(_ColorR, _ColorG, _ColorB)));
          u_xlat0_d.xyz = float3((float3(u_xlat6_d, u_xlat6_d, u_xlat6_d) * u_xlat0_d.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord2.xyz) + float3(_ColorR, _ColorG, _ColorB)));
          u_xlat0_d.xyz = float3((float3(u_xlat9, u_xlat9, u_xlat9) * u_xlat0_d.xyz));
