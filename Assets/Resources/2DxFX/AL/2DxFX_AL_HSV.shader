  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat8.xy = float2(((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz)));
          u_xlat4_d.xy = float2(((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw));
          ...
          u_xlat3.xyz = float3(((float3(float3(_Val, _Val, _Val)) * float3(0.587000012, 0.114, 0.298999995)) + (-u_xlat3.yzw)));
          ...
          u_xlat0_d.xyz = float3((float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat4_d.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3 = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat8.xy = float2(((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz)));
          u_xlat4.xy = float2(((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw));
          ...
          u_xlat0_d.xyz = float3((float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat4.xyz));
          out_f.color.w = u_xlat18;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.412999988, 0.300000012, 0.588, 0.885999978));
          u_xlat3 = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat8_d.xy = float2(((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz)));
          u_xlat4.xy = float2(((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw));
          ...
          u_xlat16_5.xyz = float3(max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_5.xyz = float3(log2(u_xlat16_5.xyz));
          u_xlat2.xyz = float3(((-u_xlat16_5.xyz) + in_f.texcoord5.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat7.xy = float2(((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz)));
          u_xlat4_d.xy = float2(((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw));
          ...
          u_xlat4_d.y = ((u_xlat2 * u_xlat0_d.z) + u_xlat0_d.x);
          u_xlat0_d.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat4_d.xyz));
