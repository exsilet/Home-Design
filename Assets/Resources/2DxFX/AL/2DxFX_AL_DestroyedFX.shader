    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((u_xlati_loop_1<9))
          {
              ...
              float _tmp_dvx_172 = sin(u_xlat4_d.xy);
              u_xlat4_d.xy = float2(_tmp_dvx_172, _tmp_dvx_172);
          ...
          u_xlat6_d.xyz = float3((u_xlat0_d.yzw * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d)));
          ...
          u_xlat7.xy = float2((u_xlat6_d.yz * u_xlat13.xx));
          u_xlat7.xy = float2(((u_xlat7.xy * float2(40, 5)) + (-u_xlat6_d.yz)));
          u_xlat2.yz = ((float2(_Distortion, _Distortion) * u_xlat7.xy) + u_xlat6_d.yz);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat1_d) + (-_Alpha));
          u_xlat6_d.xyz = float3((u_xlat0_d.xxx * u_xlat2.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((u_xlati_loop_1<9))
          {
              ...
              float _tmp_dvx_173 = sin(u_xlat5.xy);
              u_xlat5.xy = float2(_tmp_dvx_173, _tmp_dvx_173);
          ...
          u_xlat21 = (u_xlat21 * u_xlat2_d.x);
          u_xlat8.xyz = float3((float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat1_d.yzw));
          ...
          u_xlat2_d.xy = float2((u_xlat8.yz * u_xlat9.xx));
          u_xlat2_d.xy = float2(((u_xlat2_d.xy * float2(40, 5)) + (-u_xlat8.yz)));
          u_xlat3.yz = ((float2(_Distortion, _Distortion) * u_xlat2_d.xy) + u_xlat8.yz);
          u_xlat21 = ((u_xlat1_d.x * u_xlat21) + (-_Alpha));
          u_xlat1_d.xyz = float3((float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat3.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((u_xlati_loop_1<9))
          {
              ...
              float _tmp_dvx_174 = sin(u_xlat9.xy);
              u_xlat9.xy = float2(_tmp_dvx_174, _tmp_dvx_174);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((u_xlati_loop_1<9))
          {
              ...
              float _tmp_dvx_175 = sin(u_xlat4.xy);
              u_xlat4.xy = float2(_tmp_dvx_175, _tmp_dvx_175);
          ...
          u_xlat6.xyz = float3((u_xlat0_d.yzw * u_xlat1_d.xxx));
          ...
          u_xlat7.xy = float2((u_xlat6.yz * u_xlat13.xx));
          u_xlat7.xy = float2(((u_xlat7.xy * float2(40, 5)) + (-u_xlat6.yz)));
          u_xlat2.yz = ((float2(_Distortion, _Distortion) * u_xlat7.xy) + u_xlat6.yz);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat1_d.x) + (-_Alpha));
          u_xlat6.xyz = float3((u_xlat0_d.xxx * u_xlat2.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((u_xlati_loop_1<9))
          {
              ...
              u_xlat4_d = (u_xlat3.xyxy + float4(1, 0, 0, 1));
              u_xlat4_d.xy = float2(((u_xlat4_d.yw * float2(7, 7)) + u_xlat4_d.xz));
              float _tmp_dvx_176 = sin(u_xlat4_d.xy);
              u_xlat4_d.xy = float2(_tmp_dvx_176, _tmp_dvx_176);
              u_xlat4_d.xy = float2((u_xlat4_d.xy * float2(float2(_Size, _Size))));
              u_xlat4_d.xy = float2((u_xlat4_d.xy * float2(43, 43)));
              u_xlat4_d.xy = float2(frac(u_xlat4_d.xy));
              u_xlat4_d.x = ((-u_xlat20) + u_xlat4_d.x);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((u_xlati_loop_1<9))
          {
              ...
              float _tmp_dvx_177 = sin(u_xlat9_d.xy);
              u_xlat9_d.xy = float2(_tmp_dvx_177, _tmp_dvx_177);
