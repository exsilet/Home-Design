  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_168 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_168, _tmp_dvx_168, _tmp_dvx_168);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11 = (((-in_f.texcoord.x) * 5) + u_xlat6_d.x);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6_d.xxx));
          float _tmp_dvx_169 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_169, _tmp_dvx_169, _tmp_dvx_169);
          u_xlat6_d.x = sin(u_xlat11);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_170 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_170, _tmp_dvx_170, _tmp_dvx_170);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11 = (((-in_f.texcoord.x) * 5) + u_xlat6_d.x);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6_d.xxx));
          float _tmp_dvx_171 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_171, _tmp_dvx_171, _tmp_dvx_171);
          u_xlat6_d.x = sin(u_xlat11);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
