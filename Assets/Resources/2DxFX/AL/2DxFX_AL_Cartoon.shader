  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_17.xyz = float3((u_xlat10_4.xyz + u_xlat10_5.xyz));
          ...
          u_xlat16_17.xyz = float3((u_xlat10_10.xyz + u_xlat16_17.xyz));
          u_xlat16_17.xyz = float3((u_xlat10_11.xyz + u_xlat16_17.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_0.xyz + u_xlat16_17.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_8.xyz + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_9.xyz + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_6.xyz + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_7.xyz + u_xlat16_0.xyz));
          u_xlat0_d.xyz = float3((u_xlat16_0.xyz * in_f.texcoord3.xyz));
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * float3(0.777777791, 0.777777791, 0.777777791)));
          u_xlat0_d.xyz = float3(floor(u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz / float3(_ColorLevel, _ColorLevel, _ColorLevel)));
          u_xlat17 = (_EdgeSize + 0.0500000007);
          if((u_xlat17<u_xlat48))
          {
              u_xlatb48 = 1;
          }
          else
          ...
          u_xlat0_d.xyz = float3((int(u_xlatb48))?(float3(0, 0, 0)):(u_xlat0_d.xyz));
          ...
          out_f.color.xyz = float3((float3(u_xlat16_63, u_xlat16_63, u_xlat16_63) * u_xlat16_15.xyz));
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_15.xyz = float3((float3(u_xlat48, u_xlat48, u_xlat48) * _LightColor0.xyz));
          u_xlat16_15.xyz = float3((u_xlat0_d.xyz * u_xlat16_15.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0.xyz = float3((u_xlat10_6.xyz + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_7.xyz + u_xlat16_0.xyz));
          u_xlat0_d.xyz = float3((u_xlat16_0.xyz * in_f.texcoord2.xyz));
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * float3(0.777777791, 0.777777791, 0.777777791)));
          u_xlat0_d.xyz = float3(floor(u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz / float3(_ColorLevel, _ColorLevel, _ColorLevel)));
          u_xlat17 = (_EdgeSize + 0.0500000007);
          ...
          u_xlat16_15.xyz = float3(max(u_xlat10_1.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_15.xyz = float3(log2(u_xlat16_15.xyz));
          u_xlat1_d.xyz = float3(((-u_xlat16_15.xyz) + in_f.texcoord5.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_13 = tex2D(_MainTex, u_xlat13.zw);
          u_xlat16_14 = (u_xlat10_5 + u_xlat10_14);
          u_xlat16_16.xyz = float3((u_xlat10_4.xyz + u_xlat10_5.xyz));
          u_xlat16_4 = (u_xlat10_4 + u_xlat16_14);
          u_xlat16_4 = (u_xlat10_13 + u_xlat16_4);
          u_xlat16_4 = (u_xlat10_11 + u_xlat16_4);
          u_xlat16_4 = (u_xlat10_0 + u_xlat16_4);
          ...
          u_xlat16_16.xyz = float3((u_xlat10_10.xyz + u_xlat16_16.xyz));
          u_xlat16_16.xyz = float3((u_xlat10_11.xyz + u_xlat16_16.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_0.xyz + u_xlat16_16.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_8.xyz + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_9.xyz + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_6.xyz + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_7.xyz + u_xlat16_0.xyz));
          ...
          u_xlat0_d.xyz = float3((int(u_xlatb45))?(float3(0, 0, 0)):(u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat1_d, u_xlat1_d, u_xlat1_d) * u_xlat0_d.xyz));
