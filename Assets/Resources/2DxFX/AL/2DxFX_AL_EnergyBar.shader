  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3((((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + float3(1, 0, 0)));
          u_xlat3 = (u_xlat10_1 * in_f.texcoord3);
          u_xlat2.xyz = float3(((float3(_Value4, _Value4, _Value4) * u_xlat2.xyz) + u_xlat3.xyz));
          u_xlat4_d.xyz = float3(((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat2.xyz)));
          u_xlat6_d.xyz = float3(((u_xlat6_d.xxx * u_xlat4_d.xyz) + u_xlat2.xyz));
          u_xlat2.xyz = float3(((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat6_d.xyz)));
          u_xlat3.xyz = float3(((float3(float3(_Value1, _Value1, _Value1)) * u_xlat2.xyz) + u_xlat6_d.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = (u_xlat6_d.x * _Value1);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat2_d.xyz = float3((((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + float3(1, 0, 0)));
          u_xlat3 = (u_xlat10_1 * in_f.texcoord3);
          u_xlat2_d.xyz = float3(((float3(_Value4, _Value4, _Value4) * u_xlat2_d.xyz) + u_xlat3.xyz));
          u_xlat4.xyz = float3(((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat2_d.xyz)));
          u_xlat6_d.xyz = float3(((u_xlat6_d.xxx * u_xlat4.xyz) + u_xlat2_d.xyz));
          u_xlat2_d.xyz = float3(((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat6_d.xyz)));
          u_xlat3.xyz = float3(((float3(float3(_Value1, _Value1, _Value1)) * u_xlat2_d.xyz) + u_xlat6_d.xyz));
          u_xlat6_d.x = ((-_Value5) + 1);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat2.xyz = float3((((-u_xlat10_1.xyz) * in_f.texcoord2.xyz) + float3(1, 0, 0)));
          u_xlat3 = (u_xlat10_1 * in_f.texcoord2);
          u_xlat2.xyz = float3(((float3(_Value4, _Value4, _Value4) * u_xlat2.xyz) + u_xlat3.xyz));
          u_xlat4.xyz = float3(((u_xlat10_1.xyz * in_f.texcoord2.xyz) + (-u_xlat2.xyz)));
          u_xlat6.xyz = float3(((u_xlat6.xxx * u_xlat4.xyz) + u_xlat2.xyz));
          u_xlat2.xyz = float3(((u_xlat10_1.xyz * in_f.texcoord2.xyz) + (-u_xlat6.xyz)));
          u_xlat3.xyz = float3(((float3(float3(_Value1, _Value1, _Value1)) * u_xlat2.xyz) + u_xlat6.xyz));
          u_xlat6.x = ((-_Value5) + 1);
          u_xlat2.w = (-u_xlat6.x);
          u_xlat2.xyz = float3((-float3(_Value3, _Value3, _Value3)));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d = ((-_Value5) + 1);
          u_xlat0_d = ((-u_xlat2_d) * u_xlat0_d);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord1.xy).w.x;
          u_xlat0_d = ((u_xlat10_2 * in_f.texcoord3.w) + u_xlat0_d);
          u_xlat0_d = (u_xlat0_d + (-_Alpha));
          u_xlat16_1 = (u_xlat0_d + (-0.0500000007));
          if((u_xlat16_1<0))
