  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xx * float2(4.44289351, (-22.214468))));
          ...
          u_xlat6_d.xy = float2((u_xlat1_d.xy + float2(-0.5, (-0.5))));
          u_xlat4_d = length(u_xlat6_d.xy);
          u_xlat1_d.x = rsqrt(u_xlat1_d.x);
          u_xlat6_d.xy = float2((u_xlat6_d.xy * u_xlat1_d.xx));
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xz / float2(u_xlat3, u_xlat3)));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xy = float2((u_xlat1_d.xy + float2(-0.5, (-0.5))));
          u_xlat4 = length(u_xlat6.xy);
          u_xlat1_d.x = rsqrt(u_xlat1_d.x);
          u_xlat6.xy = float2((u_xlat6.xy * u_xlat1_d.xx));
          u_xlat0_d.x = ((-u_xlat0_d.x) * u_xlat4);
          u_xlat0_d.x = (u_xlat0_d.x * 10);
          u_xlat1_d.x = max(abs(u_xlat0_d.x), 1);
          u_xlat1_d.x = (float(1) / u_xlat1_d.x);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xz = (u_xlat0_d.xx * u_xlat6.xy);
          u_xlat0_d.xz = (u_xlat0_d.xz * float2(0.5, 0.5));
          u_xlat0_d.xy = float2((u_xlat0_d.xz / float2(u_xlat3_d, u_xlat3_d)));
          u_xlat0_d.xy = float2((u_xlat0_d.xy + float2(0.5, 0.5)));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w.x;
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_2 = (u_xlat0_d.x + (-0.0500000007));
