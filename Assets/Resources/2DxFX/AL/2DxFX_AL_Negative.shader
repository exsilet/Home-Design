  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3(((u_xlat0_d.xyz * float3(-2, (-2), (-2))) + float3(1, 1, 1)));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat2.xyz) + u_xlat0_d.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xyz = float3(((u_xlat0_d.xyz * float3(-2, (-2), (-2))) + float3(1, 1, 1)));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat2_d.xyz) + u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat9, u_xlat9, u_xlat9) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat9;
