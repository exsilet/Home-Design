  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat2.xy).xyz.xyz;
          u_xlat0_d.xw = (_Time.xx + float2(0.200000003, 0.600000024));
          u_xlat0_d.xw = (u_xlat0_d.xw * float2(float2(_Value1, _Value1)));
          u_xlatb2.xy = float2(bool4(u_xlat0_d.xwxx >= (-u_xlat0_d.xwxx)).xy);
          u_xlat12.xy = float2(frac(abs(u_xlat0_d.xw)));
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(8, 8)));
          u_xlat0_d.xy = float2(floor(u_xlat0_d.xy));
          u_xlat0_d.x = (((-u_xlat0_d.x) * 0.125) + u_xlat5.y);
          u_xlat3.y = (u_xlat0_d.x + 1);
          u_xlat10_0.xzw = tex2D(_MainTex2, u_xlat3.xy).xyz.xyz;
          u_xlat16_0.xzw = (u_xlat10_0.xzw + u_xlat10_1.xyz);
          u_xlat1_d.xy = float2(((in_f.texcoord.xy * float2(0.125, 0.125)) + float2(-0.0250000004, (-0.0199999996))));
          u_xlat1_d.xy = float2(((u_xlat1_d.xy * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          ...
          u_xlat16_0.xyz = float3((u_xlat16_0.xzw + u_xlat10_1.xyz));
          u_xlat1_d.xy = float2(((u_xlat16_0.xx * float2(0.015625, 0.015625)) + in_f.texcoord.xy));
          u_xlat10_15 = tex2D(_MainTex, u_xlat1_d.xy).w.x;
          u_xlat15 = (u_xlat10_15 * in_f.texcoord3.w);
          u_xlat15 = (u_xlat16_0.x * u_xlat15);
          u_xlat0_d.xyz = float3((u_xlat16_0.xyz * float3(float3(_Value2, _Value2, _Value2))));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat2_d.xy).xyz.xyz;
          u_xlat0_d.xw = (_Time.xx + float2(0.200000003, 0.600000024));
          u_xlat0_d.xw = (u_xlat0_d.xw * float2(float2(_Value1, _Value1)));
          u_xlatb2.xy = float2(bool4(u_xlat0_d.xwxx >= (-u_xlat0_d.xwxx)).xy);
          u_xlat12.xy = float2(frac(abs(u_xlat0_d.xw)));
          ...
          u_xlat2_d.xy = float2((u_xlat2_d.xy * float2(8, 8)));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4_d.xy = float2(((float2(u_xlat16_0, u_xlat16_0) * float2(0.015625, 0.015625)) + in_f.texcoord.xy));
          u_xlat10_4 = tex2D(_MainTex, u_xlat4_d.xy).w.x;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xw = (u_xlat0_d.xw * float2(float2(_Value1, _Value1)));
          u_xlatb2.xy = float2(bool4(u_xlat0_d.xwxx >= (-u_xlat0_d.xwxx)).xy);
          u_xlat12_d.xy = float2(frac(abs(u_xlat0_d.xw)));
          u_xlat0_d.xw = (u_xlat0_d.xw * float2(0.125, 0.125));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat1_d.xy).x;
          u_xlat16_0 = (u_xlat10_4 + u_xlat16_0);
          u_xlat4.xy = float2(((float2(u_xlat16_0, u_xlat16_0) * float2(0.015625, 0.015625)) + in_f.texcoord1.xy));
          u_xlat10_4 = tex2D(_MainTex, u_xlat4.xy).w.x;
