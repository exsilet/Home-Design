  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_158 = cos(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_158, _tmp_dvx_158);
          ...
          u_xlat0_d.xy = float2((u_xlat2.xy + float2(-0.5, (-0.5))));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(float2(_Inside, _Inside))) + float2(0.5, 0.5)));
          ...
          u_xlat1_d.xyz = float3((u_xlat2.xyz / u_xlat1_d.xxx));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_159 = cos(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_159, _tmp_dvx_159);
          u_xlat0_d.xw = (u_xlat0_d.xw * float2(_Distortion, _Distortion));
          u_xlat0_d.x = (u_xlat0_d.x * _Inside);
          u_xlat0_d.x = ((u_xlat0_d.x * 0.00899999961) + in_f.texcoord.y);
          u_xlat12 = ((u_xlat0_d.w * 0.00899999961) + in_f.texcoord.y);
          ...
          u_xlat0_d.xy = float2((u_xlat2_d.xy + float2(-0.5, (-0.5))));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(float2(_Inside, _Inside))) + float2(0.5, 0.5)));
          u_xlat10_2 = tex2D(_MainTex, u_xlat0_d.xy);
          ...
          u_xlat0_d.xyw = ((u_xlat0_d.xyw * float3(-0.5, (-0.5), (-0.5))) + u_xlat1_d.xzw);
          u_xlat1_d.x = ((-_Inside) + 3);
          u_xlat1_d.xyz = float3((u_xlat2_d.xyz / u_xlat1_d.xxx));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat4);
          float _tmp_dvx_160 = cos(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_160, _tmp_dvx_160);
          u_xlat0_d.xw = (u_xlat0_d.xw * float2(_Distortion, _Distortion));
          u_xlat0_d.x = (u_xlat0_d.x * _Inside);
          u_xlat0_d.x = ((u_xlat0_d.x * 0.00899999961) + in_f.texcoord.y);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.w = (u_xlat0_d.x + u_xlat8);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat4_d);
          float _tmp_dvx_161 = cos(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_161, _tmp_dvx_161);
          u_xlat0_d.xw = (u_xlat0_d.xw * float2(_Distortion, _Distortion));
          u_xlat0_d.x = (u_xlat0_d.x * _Inside);
          u_xlat0_d.x = ((u_xlat0_d.x * 0.00899999961) + in_f.texcoord.y);
          u_xlat12 = ((u_xlat0_d.w * 0.00899999961) + in_f.texcoord.y);
          ...
          u_xlat1_d.xyz = float3((u_xlat2.xyz / u_xlat1_d.xxx));
          u_xlat0_d.xyw = ((u_xlat1_d.xyz * u_xlat2.www) + u_xlat0_d.xyw);
          u_xlat0_d.xyz = float3((float3(u_xlat8, u_xlat8, u_xlat8) * u_xlat0_d.xyw));
