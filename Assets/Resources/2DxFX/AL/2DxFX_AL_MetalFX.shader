  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6_d.xxx));
          float _tmp_dvx_122 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_122, _tmp_dvx_122, _tmp_dvx_122);
          ...
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * in_f.texcoord3.xyz));
          ...
          u_xlat6_d.xyz = float3(((u_xlat0_d.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727)));
          u_xlat3.xyz = float3((u_xlat0_d.xxx * float3(2.4000001, 1.5999999, 1.5999999)));
          u_xlat3.xyz = float3((u_xlat3.xyz * u_xlat3.xyz));
          u_xlat3.xyz = float3((u_xlat3.xyz * u_xlat3.xyz));
          u_xlat6_d.xyz = float3(((float3(u_xlat15, u_xlat15, u_xlat15) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat6_d.xyz));
          ...
          u_xlat0_d.xyz = float3(((u_xlat0_d.xzw * u_xlat3.xyz) + float3(u_xlat5, u_xlat5, u_xlat5)));
          u_xlat6_d.xyz = float3(((u_xlat0_d.xyz * float3(0.5, 0.5, 0.5)) + float3(0.100000001, 0.100000001, 0.100000001)));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.215200007, 0.172199994));
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx + u_xlat6_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat1_d, u_xlat1_d, u_xlat1_d) * u_xlat0_d.xyz));
          ...
          out_f.color.xyz = float3((float3(u_xlat16_17, u_xlat16_17, u_xlat16_17) * u_xlat16_2.xyz));
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11 = (((-in_f.texcoord.x) * 5) + u_xlat6_d.x);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6_d.xxx));
          float _tmp_dvx_123 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_123, _tmp_dvx_123, _tmp_dvx_123);
          u_xlat6_d.x = sin(u_xlat11);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.215200007, 0.172199994));
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx + u_xlat6_d.xyz));
          u_xlat0_d.xyz = float3((u_xlat1_d.xxx * u_xlat0_d.xyz));
          ...
          u_xlat16_2.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * _LightColor0.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6.xxx));
          float _tmp_dvx_124 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_124, _tmp_dvx_124, _tmp_dvx_124);
          ...
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * in_f.texcoord2.xyz));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.412600011, 0.815199971, 0.172199994));
          u_xlat5 = ((-u_xlat15) + 1);
          u_xlat10 = (((-u_xlat0_d.x) * 0.115896732) + 1);
          u_xlat15 = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat10 = ((u_xlat15 * 2.58329701) + u_xlat10);
          u_xlat6.xyz = float3(((u_xlat0_d.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727)));
          u_xlat3.xyz = float3((u_xlat0_d.xxx * float3(2.4000001, 1.5999999, 1.5999999)));
          u_xlat3.xyz = float3((u_xlat3.xyz * u_xlat3.xyz));
          u_xlat3.xyz = float3((u_xlat3.xyz * u_xlat3.xyz));
          u_xlat6.xyz = float3(((float3(u_xlat15, u_xlat15, u_xlat15) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat6.xyz));
          ...
          u_xlat0_d.xzw = (u_xlat4.xyz / float3(_Distortion, _Distortion, _Distortion));
          u_xlat0_d.xyz = float3(((u_xlat0_d.xzw * u_xlat3.xyz) + float3(u_xlat5, u_xlat5, u_xlat5)));
          u_xlat6.xyz = float3(((u_xlat0_d.xyz * float3(0.5, 0.5, 0.5)) + float3(0.100000001, 0.100000001, 0.100000001)));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.215200007, 0.172199994));
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx + u_xlat6.xyz));
          u_xlat0_d.xyz = float3((u_xlat1_d.xxx * u_xlat0_d.xyz));
          out_f.color.w = u_xlat1_d.x;
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11 = (((-in_f.texcoord.x) * 5) + u_xlat6_d.x);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6_d.xxx));
          float _tmp_dvx_125 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_125, _tmp_dvx_125, _tmp_dvx_125);
          u_xlat6_d.x = sin(u_xlat11);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
