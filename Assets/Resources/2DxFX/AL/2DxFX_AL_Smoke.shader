  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2(((in_f.texcoord.xy * float2(0.0694444478, 0.0694444478)) + u_xlat1_d.xy));
          u_xlat0_d.xy = float2((u_xlat0_d.xy + float2(0.0219999999, 0.0219999999)));
          u_xlat10_0.xyz = tex2D(_MainTex2, u_xlat0_d.xy).xyz.xyz;
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * _Color2.xyz));
          u_xlat9.xy = float2((in_f.texcoord.xy + float2(-0.100000001, (-0.100000001))));
          u_xlat1_d.xy = float2(((u_xlat9.xy * float2(0.125, 0.125)) + u_xlat1_d.xy));
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat1_d.xy).xyz.xyz;
          u_xlat0_d.xyz = float3(((u_xlat10_1.xyz * _Color1.xyz) + u_xlat0_d.xyz));
          ...
          u_xlat1_d.xy = float2((u_xlat1_d.xy + in_f.texcoord.xy));
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat2 = (u_xlat10_1 * in_f.texcoord3);
          u_xlat0_d.xyz = float3((((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3(((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xyz) + u_xlat2.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3(((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xyz) + u_xlat2_d.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_0.xyz = tex2D(_MainTex2, u_xlat0_d.xy).xyz.xyz;
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * _Color2.xyz));
          u_xlat7.xy = float2((in_f.texcoord.xy + float2(-0.100000001, (-0.100000001))));
          u_xlat1_d.xy = float2(((u_xlat7.xy * float2(0.125, 0.125)) + u_xlat1_d.xy));
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat1_d.xy).xyz.xyz;
          u_xlat0_d.xyz = float3(((u_xlat10_1.xyz * _Color1.xyz) + u_xlat0_d.xyz));
          ...
          u_xlat1_d.y = (-u_xlat1_d.x);
          u_xlat3.xy = float2((u_xlat1_d.xy + in_f.texcoord.xy));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((((-u_xlat10_1.xyz) * in_f.texcoord2.xyz) + u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3(((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xyz) + u_xlat2.xyz));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = floor(u_xlat0_d.x);
          u_xlat1_d.x = (u_xlat0_d.x * 0.125);
          u_xlat0_d.xy = float2(((in_f.texcoord1.xy * float2(0.0694444478, 0.0694444478)) + u_xlat1_d.xy));
          u_xlat0_d.xy = float2((u_xlat0_d.xy + float2(0.0219999999, 0.0219999999)));
          u_xlat10_0.xyz = tex2D(_MainTex2, u_xlat0_d.xy).xyz.xyz;
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * _Color2.xyz));
          u_xlat7.xy = float2((in_f.texcoord1.xy + float2(-0.100000001, (-0.100000001))));
          u_xlat1_d.xy = float2(((u_xlat7.xy * float2(0.125, 0.125)) + u_xlat1_d.xy));
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat1_d.xy).xyz.xyz;
          u_xlat0_d.xyz = float3(((u_xlat10_1.xyz * _Color1.xyz) + u_xlat0_d.xyz));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(1, 1, 1));
          ...
          u_xlat1_d.y = (-u_xlat1_d.x);
          u_xlat3_d.xy = float2((u_xlat1_d.xy + in_f.texcoord1.xy));
          u_xlat10_3 = tex2D(_MainTex, u_xlat3_d.xy).w.x;
