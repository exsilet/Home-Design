  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((u_xlat0_d.yx * in_f.texcoord.xy));
          u_xlat14.xy = float2(floor(u_xlat1_d.xy));
          u_xlat1_d.xy = float2((u_xlat14.xy / u_xlat0_d.yx));
          ...
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * u_xlat8.xxx));
          u_xlat8.xyz = float3((u_xlat0_d.xyz * u_xlat0_d.xyz));
          u_xlat4_d.xyz = float3((u_xlat0_d.xyz * u_xlat8.xyz));
          u_xlat24 = dot(u_xlat4_d.xyz, u_xlat4_d.xyz);
          u_xlat3.y = min(u_xlat24, 1000);
          u_xlat4_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-1, (-1), (-1))));
          u_xlat3.x = dot(u_xlat4_d.xyz, u_xlat4_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          }
          else
          ...
          u_xlat4_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.248746932, (-0.0272114873), (-0.0179268718))));
          u_xlat3.x = dot(u_xlat4_d.xyz, u_xlat4_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb4 = 1;
          ...
          u_xlat11.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.0709900856, (-0.428501189), (-0.476837158))));
          ...
          u_xlat5.xyz = float3((int(u_xlatb11))?(float3(0.4140625, 0.75390625, 0.78125)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.253410816, (-0.0392498374), (-0.267751515))));
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xzw));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.6328125, 0.33984375, 0.64453125)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.0464134216, (-0.308615983), (-0.0511035323))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.359375, 0.67578125, 0.37109375)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.0293874145, (-0.0187416077), (-0.226284027))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.30859375, 0.265625, 0.609375)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.498618305, (-0.584146023), (-0.153264582))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.79296875, 0.8359375, 0.53515625)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.258132637, (-0.0670471191), (-0.0116295815))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.63671875, 0.40625, 0.2265625)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.0793337822, (-0.034081161), (-7.93337822E-05))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.4296875, 0.32421875, 0.04296875)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.506023407, (-0.122093141), (-0.0979323387))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.796875, 0.49609375, 0.4609375)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.0578343272, (-0.0578343272), (-0.0578343272))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.38671875, 0.38671875, 0.38671875)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.160075366, (-0.160075366), (-0.160075366))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.54296875, 0.54296875, 0.54296875)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.221960247, (-0.697200477), (-0.230663598))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4_d.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.60546875, 0.88671875, 0.61328125)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.156645298, (-0.122093141), (-0.513501465))));
          u_xlat0_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.319443643, (-0.319443643), (-0.319443643))));
          ...
          u_xlat3.xyz = float3((int(u_xlatb8))?(u_xlat5.xyz):(u_xlat4_d.xyz));
          u_xlat8.xyz = float3((int(u_xlatb8))?(float3(0.5390625, 0.49609375, 0.80078125)):(u_xlat5.xyz));
          if((u_xlat0_d.x<u_xlat0_d.y))
          {
              u_xlatb24 = 1;
          }
          else
          ...
          u_xlat0_d.xy = float2((int(u_xlatb24))?(u_xlat0_d.xy):(u_xlat0_d.yz));
          float _tmp_dvx_138 = sqrt(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_138, _tmp_dvx_138);
          u_xlat3.xyz = float3((int(u_xlatb24))?(u_xlat8.xyz):(u_xlat3.xyz));
          u_xlat8.xyz = float3((int(u_xlatb24))?(float3(0.68359375, 0.68359375, 0.68359375)):(u_xlat8.xyz));
          ...
          u_xlat0_d.xyz = float3((int(u_xlatb0))?(u_xlat3.xyz):(u_xlat8.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * u_xlat8.xxx));
          u_xlat8.xyz = float3((u_xlat0_d.xyz * u_xlat0_d.xyz));
          u_xlat4.xyz = float3((u_xlat0_d.xyz * u_xlat8.xyz));
          u_xlat24 = dot(u_xlat4.xyz, u_xlat4.xyz);
          u_xlat3.y = min(u_xlat24, 1000);
          u_xlat4.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-1, (-1), (-1))));
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat24 = (u_xlatb24)?(1):(float(0));
          u_xlat4.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.248746932, (-0.0272114873), (-0.0179268718))));
          u_xlat3.x = dot(u_xlat4.xyz, u_xlat4.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb4 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xzw));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.6328125, 0.33984375, 0.64453125)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.0464134216, (-0.308615983), (-0.0511035323))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.359375, 0.67578125, 0.37109375)):(u_xlat5.xyz));
          u_xlat6_d.xyz = float3(((u_xlat8.xyz * u_xlat0_d.xyz) + float3(-0.0293874145, (-0.0187416077), (-0.226284027))));
          u_xlat3.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          if((u_xlat3.x<u_xlat3.y))
          ...
          u_xlat0_d.yz = (int(u_xlatb8))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat3.xyz = float3((int(u_xlatb8))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat8.xyz = float3((int(u_xlatb8))?(float3(0.5390625, 0.49609375, 0.80078125)):(u_xlat5.xyz));
          if((u_xlat0_d.x<u_xlat0_d.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat0_d.xy = float2((int(u_xlatb24))?(u_xlat0_d.xy):(u_xlat0_d.yz));
          float _tmp_dvx_139 = sqrt(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_139, _tmp_dvx_139);
          u_xlat3.xyz = float3((int(u_xlatb24))?(u_xlat8.xyz):(u_xlat3.xyz));
          u_xlat8.xyz = float3((int(u_xlatb24))?(float3(0.68359375, 0.68359375, 0.68359375)):(u_xlat8.xyz));
          u_xlat14.x = (u_xlat1_d.x * 0.5);
          u_xlat14.x = floor(u_xlat14.x);
          ...
          u_xlat16_2.xyz = float3((float3(u_xlat21, u_xlat21, u_xlat21) * _LightColor0.xyz));
          u_xlat16_2.xyz = float3((u_xlat0_d.xyz * u_xlat16_2.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.y = (u_xlat0_d.x / u_xlat0_d.y);
          u_xlat1_d.xy = float2((u_xlat0_d.yx * in_f.texcoord.xy));
          u_xlat4_d.xy = float2(floor(u_xlat1_d.xy));
          u_xlat1_d.xy = float2((u_xlat4_d.xy / u_xlat0_d.yx));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * u_xlat8_d.xxx));
          u_xlat8_d.xyz = float3((u_xlat0_d.xyz * u_xlat0_d.xyz));
          u_xlat4.xyz = float3((u_xlat0_d.xyz * u_xlat8_d.xyz));
          u_xlat24 = dot(u_xlat4.xyz, u_xlat4.xyz);
          u_xlat3.y = min(u_xlat24, 1000);
          u_xlat4.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-1, (-1), (-1))));
          u_xlat3.x = dot(u_xlat4.xyz, u_xlat4.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb24))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat24 = (u_xlatb24)?(1):(float(0));
          u_xlat4.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.248746932, (-0.0272114873), (-0.0179268718))));
          u_xlat3.x = dot(u_xlat4.xyz, u_xlat4.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb4 = 1;
          ...
          u_xlat3.yz = (int(u_xlatb4))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat11.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.0709900856, (-0.428501189), (-0.476837158))));
          u_xlat3.x = dot(u_xlat11.xyz, u_xlat11.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb11 = 1;
          ...
          u_xlat4.xzw = (int(u_xlatb11))?(u_xlat5.xyz):(float3(u_xlat18, u_xlat18, u_xlat18));
          u_xlat5.xyz = float3((int(u_xlatb11))?(float3(0.4140625, 0.75390625, 0.78125)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.253410816, (-0.0392498374), (-0.267751515))));
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xzw));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.6328125, 0.33984375, 0.64453125)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.0464134216, (-0.308615983), (-0.0511035323))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.359375, 0.67578125, 0.37109375)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.0293874145, (-0.0187416077), (-0.226284027))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.30859375, 0.265625, 0.609375)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.498618305, (-0.584146023), (-0.153264582))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.79296875, 0.8359375, 0.53515625)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.258132637, (-0.0670471191), (-0.0116295815))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.63671875, 0.40625, 0.2265625)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.0793337822, (-0.034081161), (-7.93337822E-05))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.4296875, 0.32421875, 0.04296875)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.506023407, (-0.122093141), (-0.0979323387))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.796875, 0.49609375, 0.4609375)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.0578343272, (-0.0578343272), (-0.0578343272))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.38671875, 0.38671875, 0.38671875)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.160075366, (-0.160075366), (-0.160075366))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.54296875, 0.54296875, 0.54296875)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.221960247, (-0.697200477), (-0.230663598))));
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
              u_xlatb24 = 1;
          ...
          u_xlat4.xyz = float3((int(u_xlatb24))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat5.xyz = float3((int(u_xlatb24))?(float3(0.60546875, 0.88671875, 0.61328125)):(u_xlat5.xyz));
          u_xlat6.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.156645298, (-0.122093141), (-0.513501465))));
          u_xlat0_d.xyz = float3(((u_xlat8_d.xyz * u_xlat0_d.xyz) + float3(-0.319443643, (-0.319443643), (-0.319443643))));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, u_xlat0_d.xyz);
          u_xlat3.x = dot(u_xlat6.xyz, u_xlat6.xyz);
          if((u_xlat3.x<u_xlat3.y))
          {
          ...
          u_xlat0_d.yz = (int(u_xlatb8))?(u_xlat3.xy):(u_xlat3.yz);
          u_xlat3.xyz = float3((int(u_xlatb8))?(u_xlat5.xyz):(u_xlat4.xyz));
          u_xlat8_d.xyz = float3((int(u_xlatb8))?(float3(0.5390625, 0.49609375, 0.80078125)):(u_xlat5.xyz));
          if((u_xlat0_d.x<u_xlat0_d.y))
          {
              u_xlatb24 = 1;
          }
          ...
          u_xlat0_d.xy = float2((int(u_xlatb24))?(u_xlat0_d.xy):(u_xlat0_d.yz));
          float _tmp_dvx_140 = sqrt(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_140, _tmp_dvx_140);
          u_xlat3.xyz = float3((int(u_xlatb24))?(u_xlat8_d.xyz):(u_xlat3.xyz));
          u_xlat8_d.xyz = float3((int(u_xlatb24))?(float3(0.68359375, 0.68359375, 0.68359375)):(u_xlat8_d.xyz));
          u_xlat14.x = (u_xlat1_d.x * 0.5);
          u_xlat14.x = floor(u_xlat14.x);
          u_xlat14.x = (((-u_xlat14.x) * 2) + u_xlat1_d.x);
          u_xlat0_d.x = (u_xlat0_d.y + u_xlat0_d.x);
          ...
          u_xlat0_d.xyz = float3((int(u_xlatb0))?(u_xlat3.xyz):(u_xlat8_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat21;
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((int(u_xlatb24))?(u_xlat0_d.xy):(u_xlat0_d.yz));
          float _tmp_dvx_141 = sqrt(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_141, _tmp_dvx_141);
          u_xlat3.xyz = float3((int(u_xlatb24))?(u_xlat8.xyz):(u_xlat3.xyz));
          u_xlat8.xyz = float3((int(u_xlatb24))?(float3(0.68359375, 0.68359375, 0.68359375)):(u_xlat8.xyz));
          u_xlat14.x = (u_xlat1_d.x * 0.5);
          u_xlat14.x = floor(u_xlat14.x);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((float2(_Size, _Offset) * float2(64, 3)));
          u_xlat0_d.y = (u_xlat0_d.x / u_xlat0_d.y);
          u_xlat1_d.xy = float2((u_xlat0_d.yx * in_f.texcoord1.xy));
          u_xlat4.xy = float2(floor(u_xlat1_d.xy));
          u_xlat1_d.xy = float2((u_xlat4.xy / u_xlat0_d.yx));
          u_xlat10_0 = tex2D(_MainTex, u_xlat1_d.xy).w.x;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat2_d = ((-_Alpha) + 1);
