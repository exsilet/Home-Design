  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.y = 0;
          u_xlat0_d.xy = float2((u_xlat0_d.xy + in_f.texcoord.xy));
          ...
          u_xlat2.xy = float2((((-in_f.texcoord.xy) * float2(30, 30)) + float2(46.0999985, 46.0999985)));
          float _tmp_dvx_72 = sin(u_xlat2.xy);
          u_xlat2.xy = float2(_tmp_dvx_72, _tmp_dvx_72);
          u_xlat1_d = ((in_f.texcoord.xyyx * float4(30, 30, 75, 75)) + float4(46.0999985, 46.0999985, 46.0999985, 46.0999985));
          float _tmp_dvx_73 = sin(u_xlat1_d);
          u_xlat1_d = float4(_tmp_dvx_73, _tmp_dvx_73, _tmp_dvx_73, _tmp_dvx_73);
          u_xlat2.xy = float2((u_xlat2.xy + u_xlat1_d.xy));
          u_xlat2.xy = float2((u_xlat1_d.yx + u_xlat2.xy));
          u_xlat2.xy = float2((u_xlat1_d.zw + u_xlat2.xy));
          u_xlat2.xy = float2((u_xlat2.xy + float2(5, 5)));
          u_xlat12.xy = float2((u_xlat2.xy * float2(0.200000003, 0.200000003)));
          u_xlat12.xy = float2(floor(u_xlat12.xy));
          u_xlat2.xy = float2(((u_xlat2.xy * float2(0.200000003, 0.200000003)) + (-u_xlat12.xy)));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz.xyz;
          ...
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.yx).xyz.xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          ...
          u_xlat2.xyz = float3(((-u_xlat10_0.xyz) + u_xlat2.xxx));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat2.xyz) + u_xlat10_0.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat15;
          u_xlat16_4.xyz = float3((u_xlat0_d.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xy = float2((((-in_f.texcoord.xy) * float2(30, 30)) + float2(46.0999985, 46.0999985)));
          float _tmp_dvx_74 = sin(u_xlat2_d.xy);
          u_xlat2_d.xy = float2(_tmp_dvx_74, _tmp_dvx_74);
          u_xlat1_d = ((in_f.texcoord.xyyx * float4(30, 30, 75, 75)) + float4(46.0999985, 46.0999985, 46.0999985, 46.0999985));
          float _tmp_dvx_75 = sin(u_xlat1_d);
          u_xlat1_d = float4(_tmp_dvx_75, _tmp_dvx_75, _tmp_dvx_75, _tmp_dvx_75);
          u_xlat2_d.xy = float2((u_xlat2_d.xy + u_xlat1_d.xy));
          u_xlat2_d.xy = float2((u_xlat1_d.yx + u_xlat2_d.xy));
          u_xlat2_d.xy = float2((u_xlat1_d.zw + u_xlat2_d.xy));
          u_xlat2_d.xy = float2((u_xlat2_d.xy + float2(5, 5)));
          u_xlat12.xy = float2((u_xlat2_d.xy * float2(0.200000003, 0.200000003)));
          u_xlat12.xy = float2(floor(u_xlat12.xy));
          u_xlat2_d.xy = float2(((u_xlat2_d.xy * float2(0.200000003, 0.200000003)) + (-u_xlat12.xy)));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz.xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          ...
          u_xlat2_d.xyz = float3(((-u_xlat10_0.xyz) + u_xlat2_d.xxx));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat2_d.xyz) + u_xlat10_0.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat15;
          ...
          u_xlat16_4.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * _LightColor0.xyz));
          u_xlat16_4.xyz = float3((u_xlat0_d.xyz * u_xlat16_4.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = float2((((-in_f.texcoord.xy) * float2(30, 30)) + float2(46.0999985, 46.0999985)));
          float _tmp_dvx_76 = sin(u_xlat2.xy);
          u_xlat2.xy = float2(_tmp_dvx_76, _tmp_dvx_76);
          u_xlat1_d = ((in_f.texcoord.xyyx * float4(30, 30, 75, 75)) + float4(46.0999985, 46.0999985, 46.0999985, 46.0999985));
          float _tmp_dvx_77 = sin(u_xlat1_d);
          u_xlat1_d = float4(_tmp_dvx_77, _tmp_dvx_77, _tmp_dvx_77, _tmp_dvx_77);
          u_xlat2.xy = float2((u_xlat2.xy + u_xlat1_d.xy));
          u_xlat2.xy = float2((u_xlat1_d.yx + u_xlat2.xy));
          u_xlat2.xy = float2((u_xlat1_d.zw + u_xlat2.xy));
          u_xlat2.xy = float2((u_xlat2.xy + float2(5, 5)));
          u_xlat12_d.xy = float2((u_xlat2.xy * float2(0.200000003, 0.200000003)));
          u_xlat12_d.xy = float2(floor(u_xlat12_d.xy));
          u_xlat2.xy = float2(((u_xlat2.xy * float2(0.200000003, 0.200000003)) + (-u_xlat12_d.xy)));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz.xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat2.x = (u_xlat16_12 + u_xlat2.x);
          ...
          u_xlat0_d.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat15;
          u_xlat2.xy = float2((in_f.texcoord3.xy / in_f.texcoord3.ww));
          u_xlat10_2.xyz = tex2D(_LightBuffer, u_xlat2.xy).xyz.xyz;
          u_xlat16_4.xyz = float3(max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_4.xyz = float3(log2(u_xlat16_4.xyz));
          u_xlat2.xyz = float3(((-u_xlat16_4.xyz) + in_f.texcoord5.xyz));
          out_f.color.xyz = float3((u_xlat0_d.xyz * u_xlat2.xyz));
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = float2((((-in_f.texcoord.xy) * float2(30, 30)) + float2(46.0999985, 46.0999985)));
          float _tmp_dvx_78 = sin(u_xlat2.xy);
          u_xlat2.xy = float2(_tmp_dvx_78, _tmp_dvx_78);
          u_xlat1_d = ((in_f.texcoord.xyyx * float4(30, 30, 75, 75)) + float4(46.0999985, 46.0999985, 46.0999985, 46.0999985));
          float _tmp_dvx_79 = sin(u_xlat1_d);
          u_xlat1_d = float4(_tmp_dvx_79, _tmp_dvx_79, _tmp_dvx_79, _tmp_dvx_79);
          u_xlat2.xy = float2((u_xlat2.xy + u_xlat1_d.xy));
          u_xlat2.xy = float2((u_xlat1_d.yx + u_xlat2.xy));
          u_xlat2.xy = float2((u_xlat1_d.zw + u_xlat2.xy));
          u_xlat2.xy = float2((u_xlat2.xy + float2(5, 5)));
          u_xlat10.xy = float2((u_xlat2.xy * float2(0.200000003, 0.200000003)));
          u_xlat10.xy = float2(floor(u_xlat10.xy));
          u_xlat2.xy = float2(((u_xlat2.xy * float2(0.200000003, 0.200000003)) + (-u_xlat10.xy)));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz.xyz;
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (u_xlat0_d.x * 0.001953125);
          u_xlat0_d.y = 0;
          u_xlat0_d.xy = float2((u_xlat0_d.xy + in_f.texcoord1.xy));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w.x;
          u_xlat0_d.x = (u_xlat10_0 + (-_Alpha));
          u_xlat16_1 = (u_xlat0_d.x + (-0.0500000007));
          if((u_xlat16_1<0))
