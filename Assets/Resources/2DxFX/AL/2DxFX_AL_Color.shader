  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3((float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * _ColorX.xyz));
          out_f.color.w = u_xlat0_d;
          u_xlat16_1.xyz = float3((u_xlat2.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.xyz = float3((u_xlat2_d.xxx * _LightColor0.xyz));
          u_xlat2_d.xyz = float3((u_xlat0_d.xxx * _ColorX.xyz));
          out_f.color.w = u_xlat0_d.x;
          u_xlat16_1.xyz = float3((u_xlat16_1.xyz * u_xlat2_d.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xy = float2((in_f.texcoord3.xy / in_f.texcoord3.ww));
          u_xlat10_3.xyz = tex2D(_LightBuffer, u_xlat3.xy).xyz.xyz;
          u_xlat16_1_d.xyz = float3(max(u_xlat10_3.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_1_d.xyz = float3(log2(u_xlat16_1_d.xyz));
          u_xlat3.xyz = float3(((-u_xlat16_1_d.xyz) + in_f.texcoord5.xyz));
          u_xlat2.xyz = float3((float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * _ColorX.xyz));
          out_f.color.w = u_xlat0_d;
          out_f.color.xyz = float3((u_xlat3.xyz * u_xlat2.xyz));
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx * _ColorX.xyz));
