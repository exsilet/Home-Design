  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_39 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_39, _tmp_dvx_39, _tmp_dvx_39, _tmp_dvx_39);
          ...
          u_xlat3.xyz = float3((in_f.texcoord3.xyz * _ColorX.xyz));
          u_xlat3.xyz = float3((u_xlat0_d.xxx * u_xlat3.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.zw = ((in_f.texcoord.xy * float2(2, 2)) + u_xlat0_d.xx);
          u_xlat0_d.x = ((in_f.texcoord.y * 5) + u_xlat0_d.x);
          float _tmp_dvx_40 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_40, _tmp_dvx_40, _tmp_dvx_40, _tmp_dvx_40);
          u_xlat3.x = (u_xlat0_d.y + u_xlat0_d.z);
          u_xlat3.x = (u_xlat0_d.w + u_xlat3.x);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat3.x);
          u_xlat0_d.x = (u_xlat0_d.x + 5);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.zw = ((in_f.texcoord.xy * float2(2, 2)) + u_xlat0_d.xx);
          u_xlat0_d.x = ((in_f.texcoord.y * 5) + u_xlat0_d.x);
          float _tmp_dvx_41 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_41, _tmp_dvx_41, _tmp_dvx_41, _tmp_dvx_41);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.zw = ((in_f.texcoord.xy * float2(2, 2)) + u_xlat0_d.xx);
          u_xlat0_d.x = ((in_f.texcoord.y * 5) + u_xlat0_d.x);
          float _tmp_dvx_42 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_42, _tmp_dvx_42, _tmp_dvx_42, _tmp_dvx_42);
          u_xlat3.x = (u_xlat0_d.y + u_xlat0_d.z);
          u_xlat3.x = (u_xlat0_d.w + u_xlat3.x);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat3.x);
          u_xlat0_d.x = (u_xlat0_d.x + 5);
          ...
          u_xlat3.xyz = float3((in_f.texcoord2.xyz * _ColorX.xyz));
          u_xlat3.xyz = float3((u_xlat0_d.xxx * u_xlat3.xyz));
          out_f.color.w = u_xlat0_d.x;
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.zw = ((in_f.texcoord.xy * float2(2, 2)) + u_xlat0_d.xx);
          u_xlat0_d.x = ((in_f.texcoord.y * 5) + u_xlat0_d.x);
          float _tmp_dvx_43 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_43, _tmp_dvx_43, _tmp_dvx_43, _tmp_dvx_43);
          u_xlat3.x = (u_xlat0_d.y + u_xlat0_d.z);
          u_xlat3.x = (u_xlat0_d.w + u_xlat3.x);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat3.x);
          u_xlat0_d.x = (u_xlat0_d.x + 5);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_44 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_44, _tmp_dvx_44, _tmp_dvx_44, _tmp_dvx_44);
