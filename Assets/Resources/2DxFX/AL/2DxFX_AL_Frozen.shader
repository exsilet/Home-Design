  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat12.xy = float2(((in_f.texcoord.xy * u_xlat6_d.xx) + u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat12.xy * u_xlat6_d.xx) + u_xlat0_d.xx));
          u_xlat10_12 = tex2D(_MainTex2, u_xlat12.xy).x;
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).z.x;
          ...
          u_xlat4_d.xy = float2((((-float2(u_xlat20, u_xlat20)) * u_xlat16_4.xy) + float2(1, 1)));
          ...
          u_xlat5.xy = float2((float2(u_xlat16, u_xlat16) * u_xlat16_5.xy));
          u_xlat16 = (u_xlat10_12 * u_xlat16);
          u_xlat5.xy = float2((int(u_xlatb19))?(u_xlat5.xy):(u_xlat4_d.xy));
          ...
          u_xlat4_d.xyz = float3(((float3(u_xlat18, u_xlat18, u_xlat18) * float3(u_xlat16_0, u_xlat16_0, u_xlat16_0)) + u_xlat5.xyz));
          ...
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xz).y.x;
          ...
          u_xlat16_3.xyz = float3((u_xlat0_d.xzw * _LightColor0.xyz));
          u_xlat16_21 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
          u_xlat16_21 = max(u_xlat16_21, 0);
          out_f.color.xyz = float3((float3(u_xlat16_21, u_xlat16_21, u_xlat16_21) * u_xlat16_3.xyz));
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat20 = (u_xlat20 + u_xlat20);
          u_xlat16_4.xy = float2((((-float2(u_xlat10_12, u_xlat10_12)) * float2(0.100000001, 0.666666687)) + float2(1, 1)));
          u_xlat4.xy = float2((((-float2(u_xlat20, u_xlat20)) * u_xlat16_4.xy) + float2(1, 1)));
          u_xlat16 = (u_xlat18 * 0.666666687);
          u_xlat18 = ((u_xlat18 * 0.333333343) + (-_Value1));
          u_xlat18 = (u_xlat18 * 10);
          u_xlat18 = clamp(u_xlat18, 0, 1);
          ...
          u_xlat5.xy = float2((float2(u_xlat16, u_xlat16) * u_xlat16_5.xy));
          u_xlat16 = (u_xlat10_12 * u_xlat16);
          u_xlat5.xy = float2((int(u_xlatb19))?(u_xlat5.xy):(u_xlat4.xy));
          u_xlat16_4.x = ((-u_xlat10_12) + 1);
          u_xlat20 = (((-u_xlat20) * u_xlat16_4.x) + 1);
          u_xlat5.z = (u_xlatb19)?(u_xlat16):(u_xlat20);
          u_xlat19 = ((u_xlat18 * (-2)) + 3);
          ...
          u_xlat18 = ((u_xlat19 * u_xlat18) + 0.200000003);
          u_xlat18 = (u_xlat18 * u_xlat10_12);
          u_xlat4.xyz = float3(((float3(u_xlat18, u_xlat18, u_xlat18) * float3(u_xlat16_0, u_xlat16_0, u_xlat16_0)) + u_xlat5.xyz));
          u_xlat5.x = (((-_Time.x) * 2) + (-_Value2));
          u_xlat5.y = 0;
          u_xlat0_d.xw = (u_xlat5.xy + in_f.texcoord.xy);
          u_xlat0_d.xz = (float2(u_xlat10_12, u_xlat10_12) + u_xlat0_d.xw);
          ...
          u_xlat16_3.xyz = float3((u_xlat6_d.xxx * _LightColor0.xyz));
          u_xlat16_3.xyz = float3((u_xlat0_d.xzw * u_xlat16_3.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4_d.xy = float2(((in_f.texcoord.xy * float2(u_xlat2, u_xlat2)) + u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat4_d.xy * float2(u_xlat2, u_xlat2)) + u_xlat0_d.xx));
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).z.x;
          u_xlat0_d.x = (u_xlat10_0 * _Value2);
          u_xlat0_d.xy = float2(((u_xlat0_d.xx * float2(0.0299999993, 0.0299999993)) + in_f.texcoord.xy));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat12_d.xy = float2(((in_f.texcoord.xy * u_xlat6.xx) + u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat12_d.xy * u_xlat6.xx) + u_xlat0_d.xx));
          ...
          out_f.color.xyz = float3((u_xlat0_d.xzw * u_xlat1_d.xyz));
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xzw = (((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + u_xlat0_d.xzw);
          u_xlat0_d.xzw = ((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xzw) + u_xlat2.xyz);
          u_xlat0_d.xyz = float3((u_xlat6_d.xxx * u_xlat0_d.xzw));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.xy = float2(((in_f.texcoord1.xy * float2(u_xlat2_d, u_xlat2_d)) + u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat4.xy * float2(u_xlat2_d, u_xlat2_d)) + u_xlat0_d.xx));
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).z.x;
          u_xlat0_d.x = (u_xlat10_0 * _Value2);
          u_xlat0_d.xy = float2(((u_xlat0_d.xx * float2(0.0299999993, 0.0299999993)) + in_f.texcoord1.xy));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w.x;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat2_d = ((-_Alpha) + 1);
