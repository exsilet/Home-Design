  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb6.xy = float2(bool4(u_xlat0_d.xxxx >= float4(0.5, 0.600000024, 0, 0)).xy);
          ...
          u_xlat0_d.x = (u_xlat6_d.x * u_xlat0_d.x);
          u_xlat6_d.xy = float2(((in_f.texcoord.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat2.x = _Time.y;
          u_xlat3.x = sin(_Time.y);
          u_xlat4_d.x = cos(_Time.y);
          u_xlat2.y = (u_xlat4_d.x * _Time.y);
          u_xlat6_d.xy = float2(((u_xlat2.xy * float2(1.60000002, 1.60000002)) + u_xlat6_d.xy));
          u_xlat2.xy = float2((u_xlat2.xy * float2(1.60000002, 1.60000002)));
          u_xlat2.xy = float2(((in_f.texcoord.xy * float2(2, 2)) + u_xlat2.xy));
          ...
          float _tmp_dvx_97 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_97, _tmp_dvx_97);
          ...
          float _tmp_dvx_98 = cos(u_xlat2.yzw);
          u_xlat8.xyz = float3(_tmp_dvx_98, _tmp_dvx_98, _tmp_dvx_98);
          ...
          float _tmp_dvx_99 = sin(u_xlat6_d.xy);
          u_xlat6_d.xy = float2(_tmp_dvx_99, _tmp_dvx_99);
          u_xlat12 = ((u_xlat6_d.y * 0.300000012) + 3);
          if((u_xlat6_d.x>=0.899999976))
          {
              u_xlatb6.x = 1;
          }
          else
          ...
          u_xlat1_d.xy = float2((u_xlatb6.x)?(float2(-0.0500000007, (-0))):(float2(0, (-0))));
          u_xlat1_d.zw = lerp(float2(0, 0), float2(0.0500000007, 0), float2(u_xlatb6.xx));
          u_xlat1_d = (u_xlat1_d + u_xlat3.xyxy);
          u_xlat4_d.z = tex2D(_MainTex, u_xlat1_d.zw).z.x;
          u_xlat4_d.yw = tex2D(_MainTex, u_xlat3.xy).yw.xy;
          ...
          u_xlat0_d.xy = float2((in_f.texcoord.yx + float2(-0.5, (-0.5))));
          u_xlat0_d.xy = float2((u_xlat0_d.xy * u_xlat0_d.xy));
          u_xlat0_d.xy = float2((((-u_xlat0_d.xy) * float2(u_xlat12, u_xlat12)) + float2(1, 1)));
          ...
          u_xlat6_d.xy = float2((in_f.texcoord.xy * _Time.yy));
          ...
          u_xlat10_12 = tex2D(_MainTex, in_f.texcoord.xy).w.x;
          ...
          u_xlat6_d.xyz = float3((u_xlat0_d.xxx * u_xlat1_d.xyz));
          out_f.color.w = u_xlat0_d.x;
          u_xlat16_5.xyz = float3((u_xlat6_d.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.xy = float2(((u_xlat2_d.xy * float2(1.60000002, 1.60000002)) + u_xlat6_d.xy));
          u_xlat2_d.xy = float2((u_xlat2_d.xy * float2(1.60000002, 1.60000002)));
          u_xlat2_d.xy = float2(((in_f.texcoord.xy * float2(2, 2)) + u_xlat2_d.xy));
          ...
          u_xlat0_d.x = (u_xlat6_d.x * u_xlat0_d.x);
          u_xlat6_d.x = sin(u_xlat1_d.x);
          float _tmp_dvx_100 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_100, _tmp_dvx_100);
          u_xlat12 = (u_xlat6_d.x * 0.100000001);
          u_xlat12 = (u_xlat4.x * u_xlat12);
          u_xlat6_d.x = ((u_xlat3.x * u_xlat6_d.x) + u_xlat12);
          u_xlat6_d.x = (u_xlat6_d.x + 0.5);
          u_xlat2_d = (_Time.yyyy * float4(0.25, 4, 80, 3));
          float _tmp_dvx_101 = cos(u_xlat2_d.yzw);
          u_xlat8.xyz = float3(_tmp_dvx_101, _tmp_dvx_101, _tmp_dvx_101);
          ...
          u_xlat6_d.x = ((u_xlat1_d.x * 2) + _Time.y);
          u_xlat6_d.y = ((u_xlat1_d.y * 5) + _Time.y);
          float _tmp_dvx_102 = sin(u_xlat6_d.xy);
          u_xlat6_d.xy = float2(_tmp_dvx_102, _tmp_dvx_102);
          u_xlat12 = ((u_xlat6_d.y * 0.300000012) + 3);
          if((u_xlat6_d.x>=0.899999976))
          {
              u_xlatb6.x = 1;
          ...
          u_xlat1_d.zw = lerp(float2(0, 0), float2(0.0500000007, 0), float2(u_xlatb6.xx));
          u_xlat1_d = (u_xlat1_d + u_xlat3.xyxy);
          u_xlat4.z = tex2D(_MainTex, u_xlat1_d.zw).z.x;
          u_xlat4.yw = tex2D(_MainTex, u_xlat3.xy).yw.xy;
          ...
          u_xlat16_5.xyz = float3((u_xlat6_d.xyz * u_xlat16_5.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_103 = cos(u_xlat0_d.yzw);
          u_xlat5.xyz = float3(_tmp_dvx_103, _tmp_dvx_103, _tmp_dvx_103);
          ...
          float _tmp_dvx_104 = sin(u_xlat2.xw);
          u_xlat1_d.xz = float2(_tmp_dvx_104, _tmp_dvx_104);
          ...
          u_xlat2.xy = float2((u_xlat3.xy * float2(1.60000002, 1.60000002)));
          u_xlat2.xy = float2(((in_f.texcoord.xy * float2(2, 2)) + u_xlat2.xy));
          ...
          u_xlat10_5 = tex2D(_MainTex, in_f.texcoord.xy).w.x;
          u_xlat0_d.x = (u_xlat10_5 * u_xlat0_d.x);
          u_xlat5.xz = (in_f.texcoord.yx + float2(-0.5, (-0.5)));
          u_xlat5.xz = (u_xlat5.xz * u_xlat5.xz);
          u_xlat5.xy = float2((((-u_xlat5.xz) * float2(u_xlat10, u_xlat10)) + float2(1, 1)));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (((-u_xlat0_d.x) * 9.99999809) + 1);
          u_xlat0_d.x = (u_xlat6.x * u_xlat0_d.x);
          u_xlat6.xy = float2(((in_f.texcoord.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat2.x = _Time.y;
          u_xlat3.x = sin(_Time.y);
          u_xlat4.x = cos(_Time.y);
          u_xlat2.y = (u_xlat4.x * _Time.y);
          u_xlat6.xy = float2(((u_xlat2.xy * float2(1.60000002, 1.60000002)) + u_xlat6.xy));
          u_xlat2.xy = float2((u_xlat2.xy * float2(1.60000002, 1.60000002)));
          u_xlat2.xy = float2(((in_f.texcoord.xy * float2(2, 2)) + u_xlat2.xy));
          u_xlat10_18 = tex2D(_MainTex, u_xlat2.xy).x;
          u_xlat16_18 = (u_xlat10_18 * u_xlat10_18);
          ...
          float _tmp_dvx_105 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_105, _tmp_dvx_105);
          u_xlat12_d = (u_xlat6.x * 0.100000001);
          u_xlat12_d = (u_xlat4.x * u_xlat12_d);
          u_xlat6.x = ((u_xlat3.x * u_xlat6.x) + u_xlat12_d);
          u_xlat6.x = (u_xlat6.x + 0.5);
          u_xlat2 = (_Time.yyyy * float4(0.25, 4, 80, 3));
          float _tmp_dvx_106 = cos(u_xlat2.yzw);
          u_xlat8_d.xyz = float3(_tmp_dvx_106, _tmp_dvx_106, _tmp_dvx_106);
          ...
          float _tmp_dvx_107 = sin(u_xlat6.xy);
          u_xlat6.xy = float2(_tmp_dvx_107, _tmp_dvx_107);
          u_xlat12_d = ((u_xlat6.y * 0.300000012) + 3);
          if((u_xlat6.x>=0.899999976))
          {
              u_xlatb6.x = 1;
          }
          else
          ...
          u_xlat0_d.xy = float2((in_f.texcoord.yx + float2(-0.5, (-0.5))));
          u_xlat0_d.xy = float2((u_xlat0_d.xy * u_xlat0_d.xy));
          u_xlat0_d.xy = float2((((-u_xlat0_d.xy) * float2(u_xlat12_d, u_xlat12_d)) + float2(1, 1)));
          u_xlat0_d.x = (u_xlat0_d.y * u_xlat0_d.x);
          u_xlat1_d.x = (u_xlat0_d.x * u_xlat1_d.x);
          ...
          u_xlat6.xy = float2((in_f.texcoord.xy * _Time.yy));
          ...
          u_xlat6.xyz = float3((u_xlat0_d.xxx * u_xlat1_d.xyz));
          out_f.color.w = u_xlat0_d.x;
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (u_xlat6_d.x * u_xlat0_d.x);
          u_xlat6_d.x = sin(u_xlat1_d.x);
          float _tmp_dvx_108 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_108, _tmp_dvx_108);
          u_xlat12 = (u_xlat6_d.x * 0.100000001);
          u_xlat12 = (u_xlat4_d.x * u_xlat12);
          u_xlat6_d.x = ((u_xlat3.x * u_xlat6_d.x) + u_xlat12);
          u_xlat6_d.x = (u_xlat6_d.x + 0.5);
          u_xlat2 = (_Time.yyyy * float4(0.25, 4, 80, 3));
          float _tmp_dvx_109 = cos(u_xlat2.yzw);
          u_xlat8.xyz = float3(_tmp_dvx_109, _tmp_dvx_109, _tmp_dvx_109);
          u_xlat12 = floor(u_xlat2.x);
          u_xlat12 = ((_Time.y * 0.25) + (-u_xlat12));
          u_xlat12 = ((-u_xlat12) + in_f.texcoord.y);
          u_xlat12 = (u_xlat12 * u_xlat12);
          ...
          u_xlat6_d.x = ((u_xlat1_d.x * 2) + _Time.y);
          u_xlat6_d.y = ((u_xlat1_d.y * 5) + _Time.y);
          float _tmp_dvx_110 = sin(u_xlat6_d.xy);
          u_xlat6_d.xy = float2(_tmp_dvx_110, _tmp_dvx_110);
          u_xlat12 = ((u_xlat6_d.y * 0.300000012) + 3);
          if((u_xlat6_d.x>=0.899999976))
          {
              u_xlatb6.x = 1;
          ...
          u_xlat0_d.x = (u_xlat0_d.x * in_f.texcoord3.w);
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx * u_xlat1_d.xyz));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = (_Time.yyyy * float4(0.25, 4, 80, 3));
          u_xlat0_d.x = floor(u_xlat0_d.x);
          float _tmp_dvx_111 = cos(u_xlat0_d.yzw);
          u_xlat5.xyz = float3(_tmp_dvx_111, _tmp_dvx_111, _tmp_dvx_111);
          u_xlat0_d.x = ((_Time.y * 0.25) + (-u_xlat0_d.x));
          ...
          float _tmp_dvx_112 = sin(u_xlat2_d.xw);
          u_xlat1_d.xz = float2(_tmp_dvx_112, _tmp_dvx_112);
          u_xlat10 = (u_xlat1_d.x * 0.100000001);
          ...
          u_xlat2_d.xy = float2((u_xlat3_d.xy * float2(1.60000002, 1.60000002)));
          u_xlat2_d.xy = float2(((in_f.texcoord1.xy * float2(2, 2)) + u_xlat2_d.xy));
          ...
          u_xlat5.x = (u_xlat5.x * 0.5);
          u_xlat0_d.x = ((u_xlat0_d.x * 0.0769230798) + u_xlat5.x);
          u_xlat10_5 = tex2D(_MainTex, in_f.texcoord1.xy).w.x;
          u_xlat0_d.x = (u_xlat10_5 * u_xlat0_d.x);
