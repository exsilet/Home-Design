Shader "2DxFX/AL/PixelDie"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat10_0.xy = tex2D(_MainTex2, in_f.texcoord.xy).xy.xy;
          u_xlat0_d.xy = float2(((float2(float2(_Value1, _Value1)) * float2(1.20000005, 1.20000005)) + (-u_xlat10_0.xy)));
          u_xlat0_d.xy = float2((u_xlat0_d.xy + u_xlat0_d.xy));
          u_xlat0_d.xy = float2(clamp(u_xlat0_d.xy, 0, 1));
          u_xlat8.xy = float2(((u_xlat0_d.xy * float2(-2, (-2))) + float2(3, 3)));
          u_xlat0_d.xy = float2((u_xlat0_d.xy * u_xlat0_d.xy));
          ...
          u_xlat2.xy = float2(((u_xlat0_d.xx * float2(2, 2)) + u_xlat1_d.xy));
          ...
          u_xlat4_d.xyz = float3((u_xlat0_d.xxx * u_xlat2.xyz));
          out_f.color.w = u_xlat0_d.x;
          u_xlat16_3.xyz = float3((u_xlat4_d.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat8.x = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat2_d.xy = float2(((u_xlat0_d.xx * float2(2, 2)) + u_xlat1_d.xy));
          u_xlat0_d.x = ((u_xlat8.y * u_xlat0_d.y) + u_xlat1_d.z);
          ...
          u_xlat4.xyz = float3((u_xlat0_d.xxx * u_xlat2_d.xyz));
          out_f.color.w = u_xlat0_d.x;
          ...
          u_xlat16_3.xyz = float3((u_xlat0_d.xxx * _LightColor0.xyz));
          u_xlat16_3.xyz = float3((u_xlat4.xyz * u_xlat16_3.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = float2((float2(u_xlat0_d, u_xlat0_d) * in_f.texcoord.xy));
          u_xlat10_2 = tex2D(_MainTex, u_xlat2.xy).w.x;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xy + u_xlat0_d.xy));
          u_xlat0_d.xy = float2(clamp(u_xlat0_d.xy, 0, 1));
          u_xlat8_d.xy = float2(((u_xlat0_d.xy * float2(-2, (-2))) + float2(3, 3)));
          u_xlat0_d.xy = float2((u_xlat0_d.xy * u_xlat0_d.xy));
          ...
          u_xlat4.xyz = float3((u_xlat0_d.xxx * u_xlat2.xyz));
          out_f.color.w = u_xlat0_d.x;
          ...
          out_f.color.xyz = float3((u_xlat4.xyz * u_xlat1_d.xyz));
          return out_f;
      }
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xy = float2((float2(u_xlat0_d, u_xlat0_d) * in_f.texcoord1.xy));
          u_xlat10_2 = tex2D(_MainTex, u_xlat2_d.xy).w.x;
