  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_4 = tex2D(_MainTex, u_xlat0_d.zw).w.x;
          u_xlat16_0 = (u_xlat10_4 + u_xlat10_0);
          u_xlat4_d.xy = float2((in_f.texcoord.xy + float2(_OutLineSpread, _OutLineSpread)));
          ...
          u_xlat2.xyz = float3((int(u_xlatb4))?(u_xlat1_d.xyz):(_ColorX.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_4 = tex2D(_MainTex, u_xlat0_d.zw).w.x;
          u_xlat16_0 = (u_xlat10_4 + u_xlat10_0);
          u_xlat4.xy = float2((in_f.texcoord.xy + float2(_OutLineSpread, _OutLineSpread)));
          ...
          u_xlat2_d.xyz = float3((int(u_xlatb4))?(u_xlat1_d.xyz):(_ColorX.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((float4(_OutLineSpread, _OutLineSpread, _OutLineSpread, _OutLineSpread) * float4(-1, 1, 1, (-1))) + in_f.texcoord.xyxy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w.x;
          u_xlat10_2 = tex2D(_MainTex, u_xlat0_d.zw).w.x;
          u_xlat16_0 = (u_xlat10_2 + u_xlat10_0);
          u_xlat2.xy = float2((in_f.texcoord.xy + float2(_OutLineSpread, _OutLineSpread)));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_2 = tex2D(_MainTex, u_xlat0_d.zw).w.x;
          u_xlat16_0 = (u_xlat10_2 + u_xlat10_0);
          u_xlat2_d.xy = float2((in_f.texcoord1.xy + float2(_OutLineSpread, _OutLineSpread)));
