  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_3.xyz = float3((u_xlat10_3.xyz + u_xlat10_4.xyz));
          if((u_xlat1_d.x>=(-u_xlat1_d.x)))
          {
              u_xlatb6 = 1;
          }
          ...
          u_xlat1_d.xy = float2((u_xlat1_d.xy * float2(0.125, 8)));
          ...
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat4_d.xy).xyz.xyz;
          u_xlat16_1.xyz = float3((u_xlat10_1.xyz + u_xlat16_3.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat4.xy).xyz.xyz;
          u_xlat16_1.xyz = float3((u_xlat10_1.xyz + u_xlat16_3.xyz));
          u_xlat0_d.xyz = float3(((u_xlat16_1.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat15;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.y = (u_xlat6 + 1);
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat4.xy).xyz.xyz;
          u_xlat16_3_d.xyz = float3((u_xlat10_3.xyz + u_xlat10_4.xyz));
          if((u_xlat1_d.x>=(-u_xlat1_d.x)))
          {
              u_xlatb6 = 1;
          }
          ...
          u_xlat4.y = (u_xlat1_d.x + 1);
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat4.xy).xyz.xyz;
          u_xlat16_1_d.xyz = float3((u_xlat10_1.xyz + u_xlat16_3_d.xyz));
