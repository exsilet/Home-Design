  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat2.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = float3((float3(u_xlat14, u_xlat14, u_xlat14) + float3(0.437000006, 0.171000004, 0.0780000016)));
          u_xlat0_d.xyz = float3((((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + u_xlat3.xyz));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat2_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat12, u_xlat12, u_xlat12) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat12;
