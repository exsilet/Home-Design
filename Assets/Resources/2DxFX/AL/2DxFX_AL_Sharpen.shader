  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_3.xyz = tex2D(_MainTex, u_xlat1_d.xy).xyz.xyz;
          u_xlat10_4.xyz = tex2D(_MainTex, u_xlat1_d.zw).xyz.xyz;
          u_xlat16_5.xyz = float3((u_xlat10_0.xyz + u_xlat10_3.xyz));
          u_xlat16_5.xyz = float3((u_xlat10_4.xyz + u_xlat16_5.xyz));
          u_xlat1_d = (in_f.texcoord.xyxy + float4(0, (-0.00390625), 0, 0.00390625));
          u_xlat10_6.xyz = tex2D(_MainTex, u_xlat1_d.xy).xyz.xyz;
          u_xlat10_7.xyz = tex2D(_MainTex, u_xlat1_d.zw).xyz.xyz;
          u_xlat16_5.xyz = float3((u_xlat16_5.xyz + u_xlat10_6.xyz));
          u_xlat16_5.xyz = float3((u_xlat10_7.xyz + u_xlat16_5.xyz));
          u_xlat11.xyz = float3((u_xlat11.xxx * u_xlat16_5.xyz));
          u_xlat11.xyz = float3((u_xlat11.xyz * float3(0.200000003, 0.200000003, 0.200000003)));
          u_xlat2.xyz = float3(((u_xlat2.xxx * u_xlat10_0.xyz) + (-u_xlat11.xyz)));
          u_xlat16_5.xyz = float3(min(u_xlat10_0.xyz, u_xlat10_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_0.xyz, u_xlat10_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_4.xyz, u_xlat16_0.xyz));
          u_xlat16_3.xyz = float3(min(u_xlat10_4.xyz, u_xlat16_5.xyz));
          u_xlat16_3.xyz = float3(min(u_xlat10_6.xyz, u_xlat16_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_6.xyz, u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_7.xyz, u_xlat16_0.xyz));
          u_xlat16_3.xyz = float3(min(u_xlat10_7.xyz, u_xlat16_3.xyz));
          u_xlat2.xyz = float3(max(u_xlat2.xyz, u_xlat16_3.xyz));
          u_xlat0_d.xyz = float3(min(u_xlat16_0.xyz, u_xlat2.xyz));
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * in_f.texcoord3.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat27, u_xlat27, u_xlat27) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat27;
          u_xlat16_8.xyz = float3((u_xlat0_d.xyz * _LightColor0.xyz));
          u_xlat16_35 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
          u_xlat16_35 = max(u_xlat16_35, 0);
          out_f.color.xyz = float3((float3(u_xlat16_35, u_xlat16_35, u_xlat16_35) * u_xlat16_8.xyz));
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11.xyz = float3((u_xlat11.xxx * u_xlat16_5.xyz));
          u_xlat11.xyz = float3((u_xlat11.xyz * float3(0.200000003, 0.200000003, 0.200000003)));
          u_xlat2_d.xyz = float3(((u_xlat2_d.xxx * u_xlat10_0.xyz) + (-u_xlat11.xyz)));
          u_xlat16_5.xyz = float3(min(u_xlat10_0.xyz, u_xlat10_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_0.xyz, u_xlat10_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_4.xyz, u_xlat16_0.xyz));
          u_xlat16_3.xyz = float3(min(u_xlat10_4.xyz, u_xlat16_5.xyz));
          ...
          u_xlat16_0.xyz = float3(max(u_xlat10_7.xyz, u_xlat16_0.xyz));
          u_xlat16_3.xyz = float3(min(u_xlat10_7.xyz, u_xlat16_3.xyz));
          u_xlat2_d.xyz = float3(max(u_xlat2_d.xyz, u_xlat16_3.xyz));
          u_xlat0_d.xyz = float3(min(u_xlat16_0.xyz, u_xlat2_d.xyz));
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * in_f.texcoord3.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat27, u_xlat27, u_xlat27) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat27;
          ...
          u_xlat16_8.xyz = float3((float3(u_xlat27, u_xlat27, u_xlat27) * _LightColor0.xyz));
          u_xlat16_8.xyz = float3((u_xlat0_d.xyz * u_xlat16_8.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0.xyz = float3(max(u_xlat10_0.xyz, u_xlat10_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_4.xyz, u_xlat16_0.xyz));
          u_xlat16_3_d.xyz = float3(min(u_xlat10_4.xyz, u_xlat16_5.xyz));
          u_xlat16_3_d.xyz = float3(min(u_xlat10_6.xyz, u_xlat16_3_d.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_6.xyz, u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_7.xyz, u_xlat16_0.xyz));
          u_xlat16_3_d.xyz = float3(min(u_xlat10_7.xyz, u_xlat16_3_d.xyz));
          u_xlat2.xyz = float3(max(u_xlat2.xyz, u_xlat16_3_d.xyz));
          u_xlat0_d.xyz = float3(min(u_xlat16_0.xyz, u_xlat2.xyz));
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * in_f.texcoord2.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat27, u_xlat27, u_xlat27) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat27;
          u_xlat2.xy = float2((in_f.texcoord3.xy / in_f.texcoord3.ww));
          u_xlat10_2.xyz = tex2D(_LightBuffer, u_xlat2.xy).xyz.xyz;
          u_xlat16_8.xyz = float3(max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_8.xyz = float3(log2(u_xlat16_8.xyz));
          u_xlat2.xyz = float3(((-u_xlat16_8.xyz) + in_f.texcoord5.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_5.xyz = float3((u_xlat16_5.xyz + u_xlat10_6.xyz));
          u_xlat16_5.xyz = float3((u_xlat10_7.xyz + u_xlat16_5.xyz));
          u_xlat10.xyz = float3((u_xlat10.xxx * u_xlat16_5.xyz));
          u_xlat10.xyz = float3((u_xlat10.xyz * float3(0.200000003, 0.200000003, 0.200000003)));
          u_xlat2.xyz = float3(((u_xlat2.xxx * u_xlat10_0.xyz) + (-u_xlat10.xyz)));
          u_xlat16_5.xyz = float3(min(u_xlat10_0.xyz, u_xlat10_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_0.xyz, u_xlat10_3.xyz));
          u_xlat16_0.xyz = float3(max(u_xlat10_4.xyz, u_xlat16_0.xyz));
          u_xlat16_3.xyz = float3(min(u_xlat10_4.xyz, u_xlat16_5.xyz));
