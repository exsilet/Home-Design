  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(0.125, 8)));
          ...
          u_xlat5.xy = float2(((u_xlat1_d.zw * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          u_xlat2.y = (u_xlat0_d.x + 1);
          u_xlat1_d.xy = tex2D(_MainTex2, u_xlat2.xy).zy.xy;
          u_xlat0_d.x = (u_xlat1_d.y + 0.100000001);
          u_xlat2.xy = float2((_Time.xx + float2(0.200000003, 0.600000024)));
          u_xlat2.xy = float2((u_xlat2.xy * float2(float2(_Value1, _Value1))));
          u_xlatb12.xy = float2(bool4(u_xlat2.xyxy >= (-u_xlat2.xyxy)).xy);
          u_xlat3.xy = float2(frac(abs(u_xlat2.xy)));
          u_xlat2.z = (u_xlatb12.x)?(u_xlat3.x):((-u_xlat3.x));
          u_xlat2.w = (u_xlatb12.y)?(u_xlat3.y):((-u_xlat3.y));
          u_xlat2 = (u_xlat2 * float4(0.125, 0.125, 8, 8));
          u_xlat12.xy = float2(floor(u_xlat2.zw));
          u_xlat3.x = ((u_xlat12.x * 0.125) + u_xlat5.x);
          u_xlatb5.xz = bool4(u_xlat2.xxyy >= (-u_xlat2.xxyy)).xz;
          u_xlat2.xy = float2(frac(abs(u_xlat2.xy)));
          ...
          u_xlat2.xy = tex2D(_MainTex2, u_xlat3.xy).zy.xy;
          u_xlat2.z = (u_xlat0_d.x + u_xlat2.y);
          u_xlat1_d.z = float(0.100000001);
          u_xlat1_d.w = float(0.100000001);
          u_xlat1_d.xyz = float3((u_xlat1_d.xyz + u_xlat2.xyz));
          u_xlat0_d.xy = float2(((in_f.texcoord.xy * float2(0.125, 0.125)) + float2(-0.0250000004, (-0.0199999996))));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          u_xlat5.x = (((-u_xlat5.z) * 0.125) + u_xlat0_d.y);
          u_xlat2.x = ((u_xlat12.y * 0.125) + u_xlat0_d.x);
          u_xlat2.y = (u_xlat5.x + 1);
          u_xlat0_d.xy = tex2D(_MainTex2, u_xlat2.xy).zy.xy;
          u_xlat0_d.z = (u_xlat1_d.z + u_xlat0_d.y);
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz + u_xlat1_d.xyw));
          u_xlat1_d.xy = float2(((u_xlat0_d.yy * float2(0.015625, 0.015625)) + in_f.texcoord.xy));
          ...
          u_xlat0_d.xyz = float3(((u_xlat0_d.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat1_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat15;
          u_xlat16_9.xyz = float3((u_xlat0_d.xyz * _LightColor0.xyz));
          if((u_xlat16_4<0))
          {
              u_xlatb0 = 1;
          }
          ...
          out_f.color.xyz = float3((float3(u_xlat16_4, u_xlat16_4, u_xlat16_4) * u_xlat16_9.xyz));
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = tex2D(_MainTex2, u_xlat2_d.xy).zy.xy;
          u_xlat0_d.x = (u_xlat1_d.y + 0.100000001);
          u_xlat2_d.xy = float2((_Time.xx + float2(0.200000003, 0.600000024)));
          u_xlat2_d.xy = float2((u_xlat2_d.xy * float2(float2(_Value1, _Value1))));
          u_xlatb12.xy = float2(bool4(u_xlat2_d.xyxy >= (-u_xlat2_d.xyxy)).xy);
          u_xlat3.xy = float2(frac(abs(u_xlat2_d.xy)));
          ...
          u_xlat12.xy = float2(floor(u_xlat2_d.zw));
          u_xlat3.x = ((u_xlat12.x * 0.125) + u_xlat5.x);
          u_xlatb5.xz = bool4(u_xlat2_d.xxyy >= (-u_xlat2_d.xxyy)).xz;
          u_xlat2_d.xy = float2(frac(abs(u_xlat2_d.xy)));
          ...
          u_xlat5.x = (((-u_xlat5.x) * 0.125) + u_xlat5.y);
          u_xlat3.y = (u_xlat5.x + 1);
          u_xlat2_d.xy = tex2D(_MainTex2, u_xlat3.xy).zy.xy;
          u_xlat2_d.z = (u_xlat0_d.x + u_xlat2_d.y);
          u_xlat1_d.z = float(0.100000001);
          u_xlat1_d.w = float(0.100000001);
          u_xlat1_d.xyz = float3((u_xlat1_d.xyz + u_xlat2_d.xyz));
          u_xlat0_d.xy = float2(((in_f.texcoord.xy * float2(0.125, 0.125)) + float2(-0.0250000004, (-0.0199999996))));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          u_xlat5.x = (((-u_xlat5.z) * 0.125) + u_xlat0_d.y);
          u_xlat2_d.x = ((u_xlat12.y * 0.125) + u_xlat0_d.x);
          u_xlat2_d.y = (u_xlat5.x + 1);
          u_xlat0_d.xy = tex2D(_MainTex2, u_xlat2_d.xy).zy.xy;
          u_xlat0_d.z = (u_xlat1_d.z + u_xlat0_d.y);
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz + u_xlat1_d.xyw));
          u_xlat1_d.xy = float2(((u_xlat0_d.yy * float2(0.015625, 0.015625)) + in_f.texcoord.xy));
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.xy);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = floor(u_xlat0_d.x);
          u_xlat0_d.x = (((-u_xlat0_d.x) * 0.125) + u_xlat1_d.y);
          u_xlat4_d.xy = float2(((u_xlat1_d.zw * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          u_xlat2.y = (u_xlat0_d.x + 1);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat2.xy).y.x;
          u_xlat1_d.xy = float2((_Time.xx + float2(0.200000003, 0.600000024)));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * float2(float2(_Value1, _Value1))));
          u_xlatb9.xy = float2(bool4(u_xlat1_d.xyxy >= (-u_xlat1_d.xyxy)).xy);
          u_xlat2.xy = float2(frac(abs(u_xlat1_d.xy)));
          ...
          u_xlat9.xy = float2(floor(u_xlat1_d.zw));
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat2.xy).y.x;
          u_xlat16_0 = (u_xlat10_4 + u_xlat10_0);
          u_xlat4_d.xy = float2(((in_f.texcoord.xy * float2(0.125, 0.125)) + float2(-0.0250000004, (-0.0199999996))));
          u_xlat4_d.xy = float2(((u_xlat4_d.xy * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          u_xlat8 = (((-u_xlat4_d.z) * 0.125) + u_xlat4_d.y);
          u_xlat1_d.x = ((u_xlat9.y * 0.125) + u_xlat4_d.x);
          u_xlat1_d.y = (u_xlat8 + 1);
          u_xlat10_4 = tex2D(_MainTex2, u_xlat1_d.xy).y.x;
          u_xlat16_0 = (u_xlat10_4 + u_xlat16_0);
          u_xlat0_d.xy = float2(((float2(u_xlat16_0, u_xlat16_0) * float2(0.015625, 0.015625)) + in_f.texcoord.xy));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.w = (u_xlatb12.y)?(u_xlat3.y):((-u_xlat3.y));
          u_xlat2 = (u_xlat2 * float4(0.125, 0.125, 8, 8));
          u_xlat12_d.xy = float2(floor(u_xlat2.zw));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = floor(u_xlat0_d.x);
          u_xlat0_d.x = (((-u_xlat0_d.x) * 0.125) + u_xlat1_d.y);
          u_xlat4.xy = float2(((u_xlat1_d.zw * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          u_xlat2_d.y = (u_xlat0_d.x + 1);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat2_d.xy).y.x;
          u_xlat1_d.xy = float2((_Time.xx + float2(0.200000003, 0.600000024)));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * float2(float2(_Value1, _Value1))));
          u_xlatb9.xy = float2(bool4(u_xlat1_d.xyxy >= (-u_xlat1_d.xyxy)).xy);
          u_xlat2_d.xy = float2(frac(abs(u_xlat1_d.xy)));
          u_xlat1_d.z = (u_xlatb9.x)?(u_xlat2_d.x):((-u_xlat2_d.x));
          u_xlat1_d.w = (u_xlatb9.y)?(u_xlat2_d.y):((-u_xlat2_d.y));
          u_xlat1_d = (u_xlat1_d * float4(0.125, 0.125, 8, 8));
          u_xlat9_d.xy = float2(floor(u_xlat1_d.zw));
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat2_d.xy).y.x;
          u_xlat16_0 = (u_xlat10_4 + u_xlat10_0);
          u_xlat4.xy = float2(((in_f.texcoord1.xy * float2(0.125, 0.125)) + float2(-0.0250000004, (-0.0199999996))));
          u_xlat4.xy = float2(((u_xlat4.xy * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999)));
          u_xlat8_d = (((-u_xlat4.z) * 0.125) + u_xlat4.y);
          u_xlat1_d.x = ((u_xlat9_d.y * 0.125) + u_xlat4.x);
          u_xlat1_d.y = (u_xlat8_d + 1);
          u_xlat10_4 = tex2D(_MainTex2, u_xlat1_d.xy).y.x;
          u_xlat16_0 = (u_xlat10_4 + u_xlat16_0);
          u_xlat0_d.xy = float2(((float2(u_xlat16_0, u_xlat16_0) * float2(0.015625, 0.015625)) + in_f.texcoord1.xy));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w.x;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat4.x = ((-_Alpha) + 1);
