  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat7.xy = float2((in_f.texcoord.xy + float2(-0.5, (-0.5))));
          u_xlat1_d.xy = float2((u_xlat7.xy * u_xlat7.xy));
          u_xlat7.xy = float2((u_xlat7.yx * float2(4.19999981, 4.19999981)));
          u_xlat21 = dot(u_xlat1_d.yy, u_xlat1_d.xx);
          u_xlat21 = (u_xlat21 + 0.238095239);
          u_xlat1_d.xy = float2(((u_xlat7.yx * float2(u_xlat21, u_xlat21)) + float2(0.5, 0.5)));
          u_xlat7.xy = float2((float2(u_xlat21, u_xlat21) * u_xlat7.xy));
          u_xlat7.xy = float2((u_xlat7.xy * u_xlat7.xy));
          ...
          float _tmp_dvx_45 = cos(u_xlat2.yzw);
          u_xlat2.xyz = float3(_tmp_dvx_45, _tmp_dvx_45, _tmp_dvx_45);
          ...
          float _tmp_dvx_46 = cos(u_xlat4_d.zw);
          u_xlat0_d.xw = float2(_tmp_dvx_46, _tmp_dvx_46);
          float _tmp_dvx_47 = sin(u_xlat4_d.xy);
          u_xlat9.xy = float2(_tmp_dvx_47, _tmp_dvx_47);
          u_xlat0_d.x = ((u_xlat0_d.x * 2) + _Time.y);
          u_xlat0_d.w = ((u_xlat0_d.w * 5) + _Time.y);
          float _tmp_dvx_48 = sin(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_48, _tmp_dvx_48);
          u_xlat21 = ((u_xlat0_d.w * 0.300000012) + 3);
          u_xlat7.xy = float2((((-u_xlat7.xy) * float2(u_xlat21, u_xlat21)) + float2(1, 1)));
          u_xlat7.x = (u_xlat7.y * u_xlat7.x);
          if((u_xlat0_d.x>=0.899999976))
          {
              u_xlatb0.x = 1;
          }
          else
          ...
          u_xlat2.y = tex2D(_MainTex, u_xlat3.xy).w.x;
          ...
          u_xlat14.xy = float2(((u_xlat1_d.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat4_d.x = _Time.y;
          u_xlat14.xy = float2(((u_xlat4_d.xy * float2(1.60000002, 1.60000002)) + u_xlat14.xy));
          u_xlat16.xy = float2((u_xlat4_d.xy * float2(1.60000002, 1.60000002)));
          u_xlat16.xy = float2(((u_xlat1_d.xy * float2(2, 2)) + u_xlat16.xy));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * _Time.yy));
          ...
          u_xlat2.xyz = float3((u_xlat0_d.xxx * _ColorX.xyz));
          ...
          u_xlat10_14 = tex2D(_MainTex, in_f.texcoord.xy).w.x;
          ...
          u_xlat7.xyz = float3((u_xlat0_d.xxx * u_xlat2.xyz));
          out_f.color.w = u_xlat0_d.x;
          u_xlat16_6.xyz = float3((u_xlat7.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_49 = cos(u_xlat2_d.yzw);
          u_xlat2_d.xyz = float3(_tmp_dvx_49, _tmp_dvx_49, _tmp_dvx_49);
          u_xlat21 = ((_Time.y * 0.100000001) + (-u_xlat21));
          u_xlat21 = ((-u_xlat21) + u_xlat1_d.y);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat21) + 1);
          u_xlat0_d.x = (4 / u_xlat0_d.x);
          ...
          float _tmp_dvx_50 = cos(u_xlat4.zw);
          u_xlat0_d.xw = float2(_tmp_dvx_50, _tmp_dvx_50);
          float _tmp_dvx_51 = sin(u_xlat4.xy);
          u_xlat9.xy = float2(_tmp_dvx_51, _tmp_dvx_51);
          u_xlat0_d.x = ((u_xlat0_d.x * 2) + _Time.y);
          u_xlat0_d.w = ((u_xlat0_d.w * 5) + _Time.y);
          float _tmp_dvx_52 = sin(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_52, _tmp_dvx_52);
          u_xlat21 = ((u_xlat0_d.w * 0.300000012) + 3);
          u_xlat7.xy = float2((((-u_xlat7.xy) * float2(u_xlat21, u_xlat21)) + float2(1, 1)));
          u_xlat7.x = (u_xlat7.y * u_xlat7.x);
          if((u_xlat0_d.x>=0.899999976))
          ...
          u_xlat3.y = (u_xlat21 + (-u_xlat15));
          u_xlat0_d.xz = (u_xlat0_d.xz + u_xlat3.xy);
          u_xlat2_d.y = tex2D(_MainTex, u_xlat3.xy).w.x;
          ...
          u_xlat14.xy = float2(((u_xlat1_d.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat4.x = _Time.y;
          u_xlat14.xy = float2(((u_xlat4.xy * float2(1.60000002, 1.60000002)) + u_xlat14.xy));
          u_xlat16.xy = float2((u_xlat4.xy * float2(1.60000002, 1.60000002)));
          u_xlat16.xy = float2(((u_xlat1_d.xy * float2(2, 2)) + u_xlat16.xy));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * _Time.yy));
          u_xlat1_d.x = dot(u_xlat1_d.xy, float2(12.9898005, 78.2330017));
          u_xlat1_d.x = sin(u_xlat1_d.x);
          ...
          u_xlat2_d.xyz = float3((u_xlat0_d.xxx * _ColorX.xyz));
          u_xlat0_d.x = floor(u_xlat22);
          u_xlat0_d.x = ((-u_xlat0_d.x) + u_xlat22);
          u_xlat0_d.x = (u_xlat0_d.x + 12);
          u_xlat0_d.x = (u_xlat0_d.x * 0.0769230798);
          ...
          u_xlat7.xyz = float3((u_xlat0_d.xxx * u_xlat2_d.xyz));
          out_f.color.w = u_xlat0_d.x;
          ...
          u_xlat16_6.xyz = float3((u_xlat0_d.xxx * _LightColor0.xyz));
          u_xlat16_6.xyz = float3((u_xlat7.xyz * u_xlat16_6.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2 = (_Time.yyyy * float4(0.100000001, 4, 80, 3));
          u_xlat21 = floor(u_xlat2.x);
          float _tmp_dvx_53 = cos(u_xlat2.yzw);
          u_xlat2.xyz = float3(_tmp_dvx_53, _tmp_dvx_53, _tmp_dvx_53);
          u_xlat21 = ((_Time.y * 0.100000001) + (-u_xlat21));
          u_xlat21 = ((-u_xlat21) + u_xlat1_d.y);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat21) + 1);
          u_xlat0_d.x = (4 / u_xlat0_d.x);
          ...
          float _tmp_dvx_54 = sin(u_xlat4_d.xy);
          u_xlat0_d.xw = float2(_tmp_dvx_54, _tmp_dvx_54);
          ...
          u_xlat10_0 = tex2D(_MainTex, u_xlat3.xy).w.x;
          ...
          u_xlat7.xy = float2((((-u_xlat7.xy) * u_xlat2.xx) + float2(1, 1)));
          u_xlat7.x = (u_xlat7.y * u_xlat7.x);
          u_xlat14 = (u_xlat21 + u_xlat15);
          u_xlat21 = floor(u_xlat14);
          u_xlat14 = ((-u_xlat21) + u_xlat14);
          u_xlat21 = (u_xlat14 + (-0.5));
          u_xlatb2.xy = float2(bool4(float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) >= float4(0.5, 0.600000024, 0, 0)).xy);
          ...
          u_xlat2.xy = float2(((u_xlat1_d.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat4_d.x = _Time.y;
          u_xlat2.xy = float2(((u_xlat4_d.xy * float2(1.60000002, 1.60000002)) + u_xlat2.xy));
          u_xlat16.xy = float2((u_xlat4_d.xy * float2(1.60000002, 1.60000002)));
          u_xlat16.xy = float2(((u_xlat1_d.xy * float2(2, 2)) + u_xlat16.xy));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * _Time.yy));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2 = (_Time.yyyy * float4(0.100000001, 4, 80, 3));
          u_xlat21 = floor(u_xlat2.x);
          float _tmp_dvx_55 = cos(u_xlat2.yzw);
          u_xlat2.xyz = float3(_tmp_dvx_55, _tmp_dvx_55, _tmp_dvx_55);
          u_xlat21 = ((_Time.y * 0.100000001) + (-u_xlat21));
          u_xlat21 = ((-u_xlat21) + u_xlat1_d.y);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat21) + 1);
          u_xlat0_d.x = (4 / u_xlat0_d.x);
          ...
          u_xlat3.x = ((u_xlat21 * u_xlat0_d.x) + u_xlat1_d.x);
          u_xlat4 = (_Time.yyyy * float4(200, 20, 1.5, 5));
          float _tmp_dvx_56 = cos(u_xlat4.zw);
          u_xlat0_d.xw = float2(_tmp_dvx_56, _tmp_dvx_56);
          float _tmp_dvx_57 = sin(u_xlat4.xy);
          u_xlat9.xy = float2(_tmp_dvx_57, _tmp_dvx_57);
          u_xlat0_d.x = ((u_xlat0_d.x * 2) + _Time.y);
          u_xlat0_d.w = ((u_xlat0_d.w * 5) + _Time.y);
          float _tmp_dvx_58 = sin(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_58, _tmp_dvx_58);
          u_xlat21 = ((u_xlat0_d.w * 0.300000012) + 3);
          u_xlat7.xy = float2((((-u_xlat7.xy) * float2(u_xlat21, u_xlat21)) + float2(1, 1)));
          u_xlat7.x = (u_xlat7.y * u_xlat7.x);
          if((u_xlat0_d.x>=0.899999976))
          ...
          u_xlat16_6.xyz = float3(max(u_xlat10_1.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_6.xyz = float3(log2(u_xlat16_6.xyz));
          u_xlat1_d.xyz = float3(((-u_xlat16_6.xyz) + in_f.texcoord5.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2 = (_Time.yyyy * float4(0.100000001, 4, 80, 3));
          u_xlat21 = floor(u_xlat2.x);
          float _tmp_dvx_59 = cos(u_xlat2.yzw);
          u_xlat2.xyz = float3(_tmp_dvx_59, _tmp_dvx_59, _tmp_dvx_59);
          u_xlat21 = ((_Time.y * 0.100000001) + (-u_xlat21));
          u_xlat21 = ((-u_xlat21) + u_xlat1_d.y);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat21) + 1);
          u_xlat0_d.x = (4 / u_xlat0_d.x);
          ...
          u_xlat3.x = ((u_xlat21 * u_xlat0_d.x) + u_xlat1_d.x);
          u_xlat4_d = (_Time.yyyy * float4(200, 20, 1.5, 5));
          float _tmp_dvx_60 = cos(u_xlat4_d.zw);
          u_xlat0_d.xw = float2(_tmp_dvx_60, _tmp_dvx_60);
          float _tmp_dvx_61 = sin(u_xlat4_d.xy);
          u_xlat9.xy = float2(_tmp_dvx_61, _tmp_dvx_61);
          u_xlat0_d.x = ((u_xlat0_d.x * 2) + _Time.y);
          u_xlat0_d.w = ((u_xlat0_d.w * 5) + _Time.y);
          float _tmp_dvx_62 = sin(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_62, _tmp_dvx_62);
          u_xlat21 = ((u_xlat0_d.w * 0.300000012) + 3);
          u_xlat7.xy = float2((((-u_xlat7.xy) * float2(u_xlat21, u_xlat21)) + float2(1, 1)));
          u_xlat7.x = (u_xlat7.y * u_xlat7.x);
          if((u_xlat0_d.x>=0.899999976))
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = floor(_Time.y);
          u_xlat0_d.x = ((-u_xlat0_d.x) + _Time.y);
          u_xlat7.xy = float2((in_f.texcoord1.xy + float2(-0.5, (-0.5))));
          u_xlat1_d.xy = float2((u_xlat7.xy * u_xlat7.xy));
          u_xlat7.xy = float2((u_xlat7.yx * float2(4.19999981, 4.19999981)));
          u_xlat21 = dot(u_xlat1_d.yy, u_xlat1_d.xx);
          u_xlat21 = (u_xlat21 + 0.238095239);
          ...
          u_xlat2_d = (_Time.yyyy * float4(0.100000001, 4, 80, 3));
          u_xlat21 = floor(u_xlat2_d.x);
          float _tmp_dvx_63 = cos(u_xlat2_d.yzw);
          u_xlat2_d.xyz = float3(_tmp_dvx_63, _tmp_dvx_63, _tmp_dvx_63);
          u_xlat21 = ((_Time.y * 0.100000001) + (-u_xlat21));
          u_xlat21 = ((-u_xlat21) + u_xlat1_d.y);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat21) + 1);
          u_xlat0_d.x = (4 / u_xlat0_d.x);
          ...
          float _tmp_dvx_64 = sin(u_xlat4.xy);
          u_xlat0_d.xw = float2(_tmp_dvx_64, _tmp_dvx_64);
          u_xlat21 = (u_xlat0_d.w * 0.100000001);
          u_xlat4.x = sin(_Time.y);
          u_xlat5 = cos(_Time.y);
          u_xlat21 = (u_xlat21 * u_xlat5);
          ...
          u_xlat10_0 = tex2D(_MainTex, u_xlat3_d.xy).w.x;
          u_xlat21 = (_Time.y * 0.629999995);
          u_xlat21 = sin(u_xlat21);
          u_xlat21 = (u_xlat21 + _Time.y);
          u_xlat21 = sin(u_xlat21);
          ...
          u_xlat7.xy = float2((((-u_xlat7.xy) * u_xlat2_d.xx) + float2(1, 1)));
          u_xlat7.x = (u_xlat7.y * u_xlat7.x);
          u_xlat14 = (u_xlat21 + u_xlat15);
          u_xlat21 = floor(u_xlat14);
          u_xlat14 = ((-u_xlat21) + u_xlat14);
          ...
          u_xlat21 = (((-u_xlat21) * 9.99999809) + 1);
          u_xlat14 = (u_xlat14 * u_xlat21);
          u_xlat2_d.xy = float2(((u_xlat1_d.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat4.x = _Time.y;
          u_xlat2_d.xy = float2(((u_xlat4.xy * float2(1.60000002, 1.60000002)) + u_xlat2_d.xy));
          u_xlat16.xy = float2((u_xlat4.xy * float2(1.60000002, 1.60000002)));
          u_xlat16.xy = float2(((u_xlat1_d.xy * float2(2, 2)) + u_xlat16.xy));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * _Time.yy));
          u_xlat21 = dot(u_xlat1_d.xy, float2(12.9898005, 78.2330017));
          ...
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat14);
          u_xlat0_d.x = ((u_xlat0_d.x * 0.0769230798) + u_xlat21);
          u_xlat10_14 = tex2D(_MainTex, in_f.texcoord1.xy).w.x;
          u_xlat0_d.x = (u_xlat10_14 * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat7.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * 1.60000002);
          u_xlat7.x = ((-_Alpha) + 1);
