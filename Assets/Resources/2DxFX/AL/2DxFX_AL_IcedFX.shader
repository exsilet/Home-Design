  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + float3(u_xlat5, u_xlat5, u_xlat5)));
          float _tmp_dvx_65 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_65, _tmp_dvx_65, _tmp_dvx_65);
          u_xlat5 = sin(u_xlat9);
          ...
          u_xlat16_9.xy = float2((u_xlat16_9.xy * u_xlat16_9.xy));
          u_xlat16_3.xyz = float3(((float3(u_xlat16_5, u_xlat16_5, u_xlat16_5) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat16_3.xyz));
          ...
          u_xlat0_d.xyz = float3(((u_xlat3.xyz * float3(u_xlat12, u_xlat12, u_xlat12)) + float3(u_xlat4_d, u_xlat4_d, u_xlat4_d)));
          ...
          out_f.color.xyz = float3((float3(u_xlat16_14, u_xlat16_14, u_xlat16_14) * u_xlat16_2.xyz));
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat9 = (((-in_f.texcoord.x) * 5) + u_xlat5);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + float3(u_xlat5, u_xlat5, u_xlat5)));
          float _tmp_dvx_66 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_66, _tmp_dvx_66, _tmp_dvx_66);
          u_xlat5 = sin(u_xlat9);
          u_xlat5 = (u_xlat5 + u_xlat3.x);
          u_xlat5 = (u_xlat3.y + u_xlat5);
          u_xlat5 = (u_xlat3.z + u_xlat5);
          ...
          u_xlat16_0 = (u_xlat16_0 * u_xlat16_9.y);
          u_xlat3.x = (u_xlat16_0 * u_xlat3.y);
          u_xlat0_d.xyz = float3(((u_xlat3.xyz * float3(u_xlat12, u_xlat12, u_xlat12)) + float3(u_xlat4, u_xlat4, u_xlat4)));
          ...
          u_xlat16_2.xyz = float3((float3(u_xlat12, u_xlat12, u_xlat12) * _LightColor0.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat9 = (((-in_f.texcoord.x) * 5) + u_xlat5);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + float3(u_xlat5, u_xlat5, u_xlat5)));
          float _tmp_dvx_67 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_67, _tmp_dvx_67, _tmp_dvx_67);
          u_xlat5 = sin(u_xlat9);
          u_xlat5 = (u_xlat5 + u_xlat3.x);
          u_xlat5 = (u_xlat3.y + u_xlat5);
          u_xlat5 = (u_xlat3.z + u_xlat5);
          ...
          u_xlat16_9.xy = float2((float2(u_xlat16_0, u_xlat16_0) * float2(2.4000001, 1.5999999)));
          u_xlat16_9.xy = float2((u_xlat16_9.xy * u_xlat16_9.xy));
          u_xlat16_3_d.xyz = float3(((float3(u_xlat16_5, u_xlat16_5, u_xlat16_5) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat16_3_d.xyz));
          ...
          u_xlat16_0 = (u_xlat16_0 * u_xlat16_9.y);
          u_xlat3.x = (u_xlat16_0 * u_xlat3.y);
          u_xlat0_d.xyz = float3(((u_xlat3.xyz * float3(u_xlat12_d, u_xlat12_d, u_xlat12_d)) + float3(u_xlat4, u_xlat4, u_xlat4)));
          u_xlat0_d.xyz = float3((u_xlat1_d.xxx * u_xlat0_d.xyz));
          out_f.color.w = u_xlat1_d.x;
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat9 = (((-in_f.texcoord.x) * 5) + u_xlat5);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(5, 5, 12.5)) + float3(u_xlat5, u_xlat5, u_xlat5)));
          float _tmp_dvx_68 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_68, _tmp_dvx_68, _tmp_dvx_68);
          u_xlat5 = sin(u_xlat9);
          u_xlat5 = (u_xlat5 + u_xlat3.x);
          u_xlat5 = (u_xlat3.y + u_xlat5);
          u_xlat5 = (u_xlat3.z + u_xlat5);
