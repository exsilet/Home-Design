  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((u_xlat3.xx / u_xlat6_d.xy));
          if((in_f.texcoord.y<u_xlat6_d.y))
          {
              u_xlatb6 = 1;
          }
          else
          ...
          u_xlat7.xy = float2(((-in_f.texcoord.yx) + float2(1, 1)));
          ...
          u_xlat3.xy = float2((u_xlat3.xx / u_xlat6_d.xy));
          if((in_f.texcoord.x<u_xlat6_d.y))
          {
              u_xlatb9 = 1;
          }
          else
          ...
          u_xlat3.xyz = float3((float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * u_xlat1_d.xyz));
          u_xlat16_2.xyz = float3((u_xlat3.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = float3((u_xlat0_d.xxx * u_xlat1_d.xyz));
          ...
          u_xlat16_2.xyz = float3((u_xlat3.xyz * u_xlat16_2.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((u_xlat3.xx / u_xlat6.xy));
          if((in_f.texcoord.y<u_xlat6.y))
          {
              u_xlatb6 = 1;
          }
          else
          ...
          u_xlat3.xy = float2((u_xlat3.xx / u_xlat6.xy));
          if((in_f.texcoord.x<u_xlat6.y))
          {
              u_xlatb9 = 1;
          }
          else
          ...
          out_f.color.xyz = float3((u_xlat3.xyz * u_xlat1_d.xyz));
          return out_f;
      }
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xy = float2(((-float2(_ClipUp, _ClipDown)) + float2(1, 1)));
          u_xlat1_d.xy = float2((u_xlat3_d.xx / u_xlat6.xy));
          if((in_f.texcoord1.y<u_xlat6.y))
          {
              u_xlatb6 = 1;
          }
          else
          ...
          u_xlat7.xy = float2(((-in_f.texcoord1.yx) + float2(1, 1)));
          ...
          u_xlat6.xy = float2(((-float2(_ClipRight, _ClipLeft)) + float2(1, 1)));
          u_xlat3_d.xy = float2((u_xlat3_d.xx / u_xlat6.xy));
          if((in_f.texcoord1.x<u_xlat6.y))
          {
              u_xlatb9 = 1;
          }
          else
          ...
          if((_ClipRight<in_f.texcoord1.x))
          {
              u_xlatb1 = 1;
          }
          else
          ...
          u_xlat10_3 = tex2D(_MainTex, in_f.texcoord1.xy).w.x;
