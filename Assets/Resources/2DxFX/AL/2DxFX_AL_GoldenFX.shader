  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_2.xyz = tex2D(_MainTex, u_xlat1_d.xy).xyz.xyz;
          u_xlat10_3.xyz = tex2D(_MainTex, u_xlat1_d.zw).xyz.xyz;
          ...
          u_xlat1_d = ((float4(_Distortion, _Distortion, _Distortion, _Distortion) * float4(-0.00600000005, 0.00600000005, 0.00600000005, 0.00600000005)) + in_f.texcoord.xyxy);
          u_xlat10_3.xyz = tex2D(_MainTex, u_xlat1_d.zw).xyz.xyz;
          u_xlat10_4.xyz = tex2D(_MainTex, u_xlat1_d.xy).xyz.xyz;
          ...
          u_xlat2.xy = float2(((-u_xlat8.yx) + u_xlat2.xw));
          u_xlat2.x = max(abs(u_xlat2.y), abs(u_xlat2.x));
          u_xlat2.x = rsqrt(u_xlat2.x);
          u_xlat2.x = (float(1) / u_xlat2.x);
          u_xlat0_d.xyz = float3(((u_xlat2.xxx * float3(4.5, 1.80000007, (-1.50000012))) + float3(0.100000001, 0.180000007, 0.300000012)));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat8.x = dot(u_xlat10_4.xyz, float3(0.333332986, 0.333332986, 0.333332986));
          u_xlat8.y = dot(u_xlat10_3.xyz, float3(0.333332986, 0.333332986, 0.333332986));
          u_xlat2_d.xy = float2(((-u_xlat8.yx) + u_xlat2_d.xw));
          u_xlat2_d.x = max(abs(u_xlat2_d.y), abs(u_xlat2_d.x));
          u_xlat2_d.x = rsqrt(u_xlat2_d.x);
          u_xlat2_d.x = (float(1) / u_xlat2_d.x);
          u_xlat0_d.xyz = float3(((u_xlat2_d.xxx * float3(4.5, 1.80000007, (-1.50000012))) + float3(0.100000001, 0.180000007, 0.300000012)));
          u_xlat0_d = (u_xlat0_d * in_f.texcoord3);
          u_xlat0_d.xyz = float3((u_xlat0_d.www * u_xlat0_d.xyz));
          out_f.color.w = u_xlat0_d.w;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = float2(((-u_xlat8_d.yx) + u_xlat2.xw));
          u_xlat2.x = max(abs(u_xlat2.y), abs(u_xlat2.x));
          u_xlat2.x = rsqrt(u_xlat2.x);
          u_xlat2.x = (float(1) / u_xlat2.x);
          u_xlat0_d.xyz = float3(((u_xlat2.xxx * float3(4.5, 1.80000007, (-1.50000012))) + float3(0.100000001, 0.180000007, 0.300000012)));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = float2(((-u_xlat7.yx) + u_xlat2.xw));
          u_xlat2.x = max(abs(u_xlat2.y), abs(u_xlat2.x));
          u_xlat2.x = rsqrt(u_xlat2.x);
          u_xlat2.x = (float(1) / u_xlat2.x);
          u_xlat0_d.xyz = float3(((u_xlat2.xxx * float3(4.5, 1.80000007, (-1.50000012))) + float3(0.100000001, 0.180000007, 0.300000012)));
