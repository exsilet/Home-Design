  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat12 = (2 / u_xlat12);
          u_xlat0_d.xy = float2((u_xlat0_d.xy / float2(u_xlat12, u_xlat12)));
          u_xlat10_0.xyw = tex2D(_MainTex2, u_xlat0_d.xy).xyz.xyz;
          u_xlat1_d.x = (u_xlat8 * 20);
          u_xlat0_d.xyw = (u_xlat10_0.xyw * u_xlat1_d.xxx);
          u_xlat1_d.xy = float2(((u_xlat0_d.xy * float2(0.03125, 0.03125)) + in_f.texcoord.xy));
          ...
          u_xlat1_d.xyz = float3(((u_xlat1_d.xxx * float3(0.5, 0.5, 0.5)) + u_xlat2.xyz));
          ...
          u_xlat16_3.xyz = float3((u_xlat0_d.xyw * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.x = clamp(u_xlat1_d.x, 0, 1);
          u_xlat1_d.x = ((-u_xlat1_d.x) + 1);
          u_xlat1_d.xyz = float3(((u_xlat1_d.xxx * float3(0.5, 0.5, 0.5)) + u_xlat2_d.xyz));
          ...
          u_xlat16_3.xyz = float3((float3(u_xlat8, u_xlat8, u_xlat8) * _LightColor0.xyz));
          u_xlat16_3.xyz = float3((u_xlat0_d.xyw * u_xlat16_3.xyz));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat9 = (2 / u_xlat9);
          u_xlat0_d.xy = float2((u_xlat0_d.xy / float2(u_xlat9, u_xlat9)));
          u_xlat10_0.xy = tex2D(_MainTex2, u_xlat0_d.xy).xy.xy;
          u_xlat9 = (u_xlat6_d * 20);
          u_xlat0_d.xy = float2((float2(u_xlat9, u_xlat9) * u_xlat10_0.xy));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.03125, 0.03125)) + in_f.texcoord.xy));
          ...
          u_xlat10_0.x = tex2D(_MainTex, u_xlat1_d.xy).w.x;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xy / float2(u_xlat12_d, u_xlat12_d)));
          u_xlat10_0.xyw = tex2D(_MainTex2, u_xlat0_d.xy).xyz.xyz;
          ...
          out_f.color.xyz = float3((u_xlat0_d.xyw * u_xlat1_d.xyz));
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.x = ((u_xlat0_d.x * 0.125) + u_xlat1_d.x);
          u_xlat2.yz = (((-u_xlat0_d.yw) * float2(0.125, 0.125)) + u_xlat1_d.yz);
          u_xlat0_d.xyz = float3((float3(u_xlat8, u_xlat8, u_xlat8) * u_xlat2.xyz));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xy / float2(u_xlat9_d, u_xlat9_d)));
          u_xlat10_0.xy = tex2D(_MainTex2, u_xlat0_d.xy).xy.xy;
          u_xlat9_d = (u_xlat6 * 20);
          u_xlat0_d.xy = float2((float2(u_xlat9_d, u_xlat9_d) * u_xlat10_0.xy));
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.03125, 0.03125)) + in_f.texcoord1.xy));
