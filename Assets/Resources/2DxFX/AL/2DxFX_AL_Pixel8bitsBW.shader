  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((-_Alpha) + 1);
          u_xlat5.x = (_Size * 64);
          u_xlat10.xy = float2((u_xlat5.xx * in_f.texcoord.xy));
          u_xlat10.xy = float2(floor(u_xlat10.xy));
          u_xlat5.xy = float2((u_xlat10.xy / u_xlat5.xx));
          ...
          u_xlat4_d.xyz = float3(((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-2.69999982E-05, (-2.69999982E-05), (-2.69999982E-05))));
          u_xlat1_d.xyz = float3(((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-0.941192091, (-0.941192091), (-0.941192091))));
          ...
          u_xlat1_d.z = 1000;
          u_xlat1_d.xy = float2((int(u_xlatb15))?(u_xlat1_d.xy):(u_xlat1_d.yz));
          float _tmp_dvx_145 = sqrt(u_xlat1_d.xy);
          u_xlat1_d.xy = float2(_tmp_dvx_145, _tmp_dvx_145);
          u_xlat1_d.x = (u_xlat1_d.y + u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.y / u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.x + 1);
          if((u_xlat1_d.x<u_xlat5.x))
          {
              u_xlatb5 = 1;
          }
          else
          ...
          u_xlat16_2.xyz = float3((u_xlat5.xxx * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5.x = (_Size * 64);
          u_xlat10_d.xy = float2((u_xlat5.xx * in_f.texcoord.xy));
          u_xlat10_d.xy = float2(floor(u_xlat10_d.xy));
          u_xlat5.xy = float2((u_xlat10_d.xy / u_xlat5.xx));
          u_xlat10_1 = tex2D(_MainTex, u_xlat5.xy);
          u_xlat5.x = (u_xlat5.y + u_xlat5.x);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          ...
          u_xlat3.xyz = float3((u_xlat1_d.xyz * u_xlat1_d.xyz));
          u_xlat4.xyz = float3(((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-2.69999982E-05, (-2.69999982E-05), (-2.69999982E-05))));
          u_xlat1_d.xyz = float3(((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-0.941192091, (-0.941192091), (-0.941192091))));
          u_xlat10_d.x = dot(u_xlat1_d.xyz, u_xlat1_d.xyz);
          u_xlat1_d.x = dot(u_xlat4.xyz, u_xlat4.xyz);
          u_xlat1_d.y = min(u_xlat10_d.x, 1000);
          if((u_xlat10_d.x<1000))
          {
              u_xlatb10 = 1;
          }
          else
          ...
          u_xlat1_d.z = 1000;
          u_xlat1_d.xy = float2((int(u_xlatb15))?(u_xlat1_d.xy):(u_xlat1_d.yz));
          float _tmp_dvx_146 = sqrt(u_xlat1_d.xy);
          u_xlat1_d.xy = float2(_tmp_dvx_146, _tmp_dvx_146);
          u_xlat1_d.x = (u_xlat1_d.y + u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.y / u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.x + 1);
          if((u_xlat1_d.x<u_xlat5.x))
          ...
          u_xlat16_2.xyz = float3((u_xlat5.xxx * u_xlat16_2.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.z = 1000;
          u_xlat1_d.xy = float2((int(u_xlatb15))?(u_xlat1_d.xy):(u_xlat1_d.yz));
          float _tmp_dvx_147 = sqrt(u_xlat1_d.xy);
          u_xlat1_d.xy = float2(_tmp_dvx_147, _tmp_dvx_147);
          u_xlat1_d.x = (u_xlat1_d.y + u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.y / u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.x + 1);
          if((u_xlat1_d.x<u_xlat5.x))
          ...
          u_xlat10_0.xzw = tex2D(_LightBuffer, u_xlat0_d.xz).xyz.xyz;
          u_xlat16_2_d.xyz = float3(max(u_xlat10_0.xzw, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_2_d.xyz = float3(log2(u_xlat16_2_d.xyz));
          u_xlat0_d.xzw = ((-u_xlat16_2_d.xyz) + in_f.texcoord5.xyz);
          out_f.color.xyz = float3((u_xlat0_d.xzw * u_xlat5.xxx));
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.z = 1000;
          u_xlat1_d.xy = float2((int(u_xlatb15))?(u_xlat1_d.xy):(u_xlat1_d.yz));
          float _tmp_dvx_148 = sqrt(u_xlat1_d.xy);
          u_xlat1_d.xy = float2(_tmp_dvx_148, _tmp_dvx_148);
          u_xlat1_d.x = (u_xlat1_d.y + u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.y / u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.x + 1);
          if((u_xlat1_d.x<u_xlat5.x))
          ...
          u_xlat10.x = (u_xlatb15)?(u_xlat10.x):(float(0));
          u_xlat5.x = (u_xlatb5)?(u_xlat10.x):(u_xlat1_d.x);
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx * u_xlat5.xxx));
