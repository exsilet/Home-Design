  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_81 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_81, _tmp_dvx_81);
          ...
          float _tmp_dvx_82 = cos(u_xlat2.yzw);
          u_xlat8.xyz = float3(_tmp_dvx_82, _tmp_dvx_82, _tmp_dvx_82);
          ...
          float _tmp_dvx_83 = sin(u_xlat6_d.xy);
          u_xlat6_d.xy = float2(_tmp_dvx_83, _tmp_dvx_83);
          ...
          u_xlat10_6 = tex2D(_MainTex, in_f.texcoord.xy).w.x;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (u_xlat6_d.x * u_xlat0_d.x);
          u_xlat6_d.x = sin(u_xlat1_d.x);
          float _tmp_dvx_84 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_84, _tmp_dvx_84);
          u_xlat12 = (u_xlat6_d.x * 0.100000001);
          u_xlat12 = (u_xlat4.x * u_xlat12);
          u_xlat6_d.x = ((u_xlat3.x * u_xlat6_d.x) + u_xlat12);
          u_xlat6_d.x = (u_xlat6_d.x + 0.5);
          u_xlat2_d = (_Time.yyyy * float4(0.25, 4, 80, 3));
          float _tmp_dvx_85 = cos(u_xlat2_d.yzw);
          u_xlat8.xyz = float3(_tmp_dvx_85, _tmp_dvx_85, _tmp_dvx_85);
          ...
          u_xlat6_d.x = ((u_xlat1_d.x * 2) + _Time.y);
          u_xlat6_d.y = ((u_xlat1_d.y * 5) + _Time.y);
          float _tmp_dvx_86 = sin(u_xlat6_d.xy);
          u_xlat6_d.xy = float2(_tmp_dvx_86, _tmp_dvx_86);
          u_xlat12 = ((u_xlat6_d.y * 0.300000012) + 3);
          if((u_xlat6_d.x>=0.899999976))
          {
              u_xlatb6.x = 1;
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_87 = cos(u_xlat0_d.yzw);
          u_xlat5.xyz = float3(_tmp_dvx_87, _tmp_dvx_87, _tmp_dvx_87);
          ...
          float _tmp_dvx_88 = sin(u_xlat2.xw);
          u_xlat1_d.xz = float2(_tmp_dvx_88, _tmp_dvx_88);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_89 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_89, _tmp_dvx_89);
          u_xlat12_d = (u_xlat6.x * 0.100000001);
          u_xlat12_d = (u_xlat4.x * u_xlat12_d);
          u_xlat6.x = ((u_xlat3.x * u_xlat6.x) + u_xlat12_d);
          u_xlat6.x = (u_xlat6.x + 0.5);
          u_xlat2 = (_Time.yyyy * float4(0.25, 4, 80, 3));
          float _tmp_dvx_90 = cos(u_xlat2.yzw);
          u_xlat8_d.xyz = float3(_tmp_dvx_90, _tmp_dvx_90, _tmp_dvx_90);
          ...
          float _tmp_dvx_91 = sin(u_xlat6.xy);
          u_xlat6.xy = float2(_tmp_dvx_91, _tmp_dvx_91);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (u_xlat6_d.x * u_xlat0_d.x);
          u_xlat6_d.x = sin(u_xlat1_d.x);
          float _tmp_dvx_92 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_92, _tmp_dvx_92);
          u_xlat12 = (u_xlat6_d.x * 0.100000001);
          u_xlat12 = (u_xlat4_d.x * u_xlat12);
          u_xlat6_d.x = ((u_xlat3.x * u_xlat6_d.x) + u_xlat12);
          u_xlat6_d.x = (u_xlat6_d.x + 0.5);
          u_xlat2 = (_Time.yyyy * float4(0.25, 4, 80, 3));
          float _tmp_dvx_93 = cos(u_xlat2.yzw);
          u_xlat8.xyz = float3(_tmp_dvx_93, _tmp_dvx_93, _tmp_dvx_93);
          u_xlat12 = floor(u_xlat2.x);
          u_xlat12 = ((_Time.y * 0.25) + (-u_xlat12));
          u_xlat12 = ((-u_xlat12) + in_f.texcoord.y);
          u_xlat12 = (u_xlat12 * u_xlat12);
          ...
          u_xlat6_d.x = ((u_xlat1_d.x * 2) + _Time.y);
          u_xlat6_d.y = ((u_xlat1_d.y * 5) + _Time.y);
          float _tmp_dvx_94 = sin(u_xlat6_d.xy);
          u_xlat6_d.xy = float2(_tmp_dvx_94, _tmp_dvx_94);
          u_xlat12 = ((u_xlat6_d.y * 0.300000012) + 3);
          if((u_xlat6_d.x>=0.899999976))
          {
              u_xlatb6.x = 1;
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = (_Time.yyyy * float4(0.25, 4, 80, 3));
          u_xlat0_d.x = floor(u_xlat0_d.x);
          float _tmp_dvx_95 = cos(u_xlat0_d.yzw);
          u_xlat5.xyz = float3(_tmp_dvx_95, _tmp_dvx_95, _tmp_dvx_95);
          u_xlat0_d.x = ((_Time.y * 0.25) + (-u_xlat0_d.x));
          ...
          float _tmp_dvx_96 = sin(u_xlat2_d.xw);
          u_xlat1_d.xz = float2(_tmp_dvx_96, _tmp_dvx_96);
          u_xlat10 = (u_xlat1_d.x * 0.100000001);
