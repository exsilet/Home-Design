  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((_Time.xy + float2(0.100000001, 0.100000001)));
          u_xlat1_d.xy = float2(((u_xlat1_d.xy * float2(12, 12)) + float2(50, 50)));
          u_xlat1_d.xy = float2(floor(u_xlat1_d.xy));
          u_xlat0_d = (u_xlat0_d * u_xlat1_d.xyxy);
          u_xlat1_d.xy = float2((u_xlat1_d.xy * float2(2, 1)));
          ...
          float _tmp_dvx_149 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_149, _tmp_dvx_149);
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(43758.5469, 43758.5469)));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xy, float2(127.099998, 311.700012));
          u_xlat0_d.y = dot(u_xlat0_d.zw, float2(127.099998, 311.700012));
          float _tmp_dvx_150 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_150, _tmp_dvx_150);
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(43758.5469, 43758.5469)));
          u_xlat0_d.xy = float2(frac(u_xlat0_d.xy));
          u_xlat6_d = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat6_d * u_xlat0_d.x);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xy, float2(127.099998, 311.700012));
          u_xlat0_d.y = dot(u_xlat0_d.zw, float2(127.099998, 311.700012));
          float _tmp_dvx_151 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_151, _tmp_dvx_151);
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(43758.5469, 43758.5469)));
          u_xlat0_d.xy = float2(frac(u_xlat0_d.xy));
          u_xlat6_d = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat6_d * u_xlat0_d.x);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xy, float2(127.099998, 311.700012));
          u_xlat0_d.y = dot(u_xlat0_d.zw, float2(127.099998, 311.700012));
          float _tmp_dvx_152 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_152, _tmp_dvx_152);
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(43758.5469, 43758.5469)));
          u_xlat0_d.xy = float2(frac(u_xlat0_d.xy));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xy, float2(127.099998, 311.700012));
          u_xlat0_d.y = dot(u_xlat0_d.zw, float2(127.099998, 311.700012));
          float _tmp_dvx_153 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_153, _tmp_dvx_153);
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(43758.5469, 43758.5469)));
          u_xlat0_d.xy = float2(frac(u_xlat0_d.xy));
          u_xlat6_d = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat6_d * u_xlat0_d.x);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xy, float2(127.099998, 311.700012));
          u_xlat0_d.y = dot(u_xlat0_d.zw, float2(127.099998, 311.700012));
          float _tmp_dvx_154 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_154, _tmp_dvx_154);
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(43758.5469, 43758.5469)));
          u_xlat0_d.xy = float2(frac(u_xlat0_d.xy));
          u_xlat6 = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat6 * u_xlat0_d.x);
