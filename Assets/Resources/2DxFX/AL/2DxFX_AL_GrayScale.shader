  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + float3(u_xlat11, u_xlat11, u_xlat11)));
          u_xlat0_d.xyz = float3(((float3(_EffectAmount, _EffectAmount, _EffectAmount) * u_xlat0_d.xyz) + u_xlat2.xyz));
          ...
          out_f.color.xyz = float3((float3(u_xlat16_10, u_xlat16_10, u_xlat16_10) * u_xlat16_1.xyz));
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + float3(u_xlat11, u_xlat11, u_xlat11)));
          u_xlat0_d.xyz = float3(((float3(_EffectAmount, _EffectAmount, _EffectAmount) * u_xlat0_d.xyz) + u_xlat2_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat9, u_xlat9, u_xlat9) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat9;
          ...
          u_xlat16_1.xyz = float3((float3(u_xlat9, u_xlat9, u_xlat9) * _LightColor0.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11 = dot(u_xlat2.xyz, float3(0.300000012, 0.589999974, 0.109999999));
          u_xlat0_d.xyz = float3((((-u_xlat10_0.xyz) * in_f.texcoord2.xyz) + float3(u_xlat11, u_xlat11, u_xlat11)));
          u_xlat0_d.xyz = float3(((float3(_EffectAmount, _EffectAmount, _EffectAmount) * u_xlat0_d.xyz) + u_xlat2.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat9, u_xlat9, u_xlat9) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat9;
