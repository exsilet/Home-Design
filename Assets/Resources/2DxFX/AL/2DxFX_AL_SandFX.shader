  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xx * float2(41.9400024, 10.4666672)));
          float _tmp_dvx_7 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_7, _tmp_dvx_7);
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy));
          ...
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat1_d.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (in_f.texcoord.y * _Distortion);
          u_xlat0_d.xy = float2((u_xlat0_d.xx * float2(41.9400024, 10.4666672)));
          float _tmp_dvx_8 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_8, _tmp_dvx_8);
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat1_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlat12 = ((-_Alpha) + 1);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (in_f.texcoord.y * _Distortion);
          u_xlat0_d.xy = float2((u_xlat0_d.xx * float2(41.9400024, 10.4666672)));
          float _tmp_dvx_9 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_9, _tmp_dvx_9);
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (in_f.texcoord.y * _Distortion);
          u_xlat0_d.xy = float2((u_xlat0_d.xx * float2(41.9400024, 10.4666672)));
          float _tmp_dvx_10 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_10, _tmp_dvx_10);
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (in_f.texcoord.y * _Distortion);
          u_xlat0_d.xy = float2((u_xlat0_d.xx * float2(41.9400024, 10.4666672)));
          float _tmp_dvx_11 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_11, _tmp_dvx_11);
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat1_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlat12 = ((-_Alpha) + 1);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xx * float2(41.9400024, 10.4666672)));
          float _tmp_dvx_12 = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = float2(_tmp_dvx_12, _tmp_dvx_12);
          u_xlat0_d.xy = float2(((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord1.xy));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w.x;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat2_d = ((-_Alpha) + 1);
