  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((((-float3(_Distortion, _Distortion, _Distortion)) * float3(0.00390625, 0.00390625, 0.00390625)) + in_f.texcoord.xyx));
          ...
          u_xlat2.xyz = float3(in_f.texcoord3.xyz);
          u_xlat2.w = 0.0625;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = ((u_xlat10_3 * float4(2, 2, 2, 2)) + u_xlat16_0);
          u_xlat16_0 = (u_xlat10_2 + u_xlat16_0);
          u_xlat2_d.xyz = float3(in_f.texcoord3.xyz);
          u_xlat2_d.w = 0.0625;
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.xy).w.x;
          u_xlat16_0 = ((u_xlat10_6 * 2) + u_xlat16_0);
          u_xlat1_d.w = (((-_Distortion) * 0.00390625) + in_f.texcoord.y);
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.zw).w.x;
          u_xlat16_0 = (u_xlat10_6 + u_xlat16_0);
          u_xlat1_d.x = ((_Distortion * 0.00390625) + in_f.texcoord.x);
          u_xlat1_d.y = in_f.texcoord.y;
          u_xlat10_9 = tex2D(_MainTex, u_xlat1_d.xy).w.x;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = ((u_xlat10_3 * float4(2, 2, 2, 2)) + u_xlat16_0);
          u_xlat16_0 = (u_xlat10_2 + u_xlat16_0);
          u_xlat2.xyz = float3(in_f.texcoord2.xyz);
          u_xlat2.w = 0.0625;
          u_xlat0_d = (u_xlat16_0 * u_xlat2);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat10_1.w);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((((-float3(_Distortion, _Distortion, _Distortion)) * float3(0.00390625, 0.00390625, 0.00390625)) + in_f.texcoord1.xyx));
          u_xlat10_6 = tex2D(_MainTex, u_xlat0_d.zw).w.x;
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w.x;
          u_xlat16_0 = ((u_xlat10_6 * 2) + u_xlat10_0);
