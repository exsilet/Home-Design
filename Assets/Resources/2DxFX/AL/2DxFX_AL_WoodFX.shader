  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = float2((in_f.texcoord.xy + float2(-0.0500000007, 0.0199999996)));
          u_xlat10 = (((-u_xlat2.x) * 20) + 46.0999985);
          u_xlat10 = sin(u_xlat10);
          u_xlat3.xyz = float3(((u_xlat2.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985)));
          u_xlat10_2.xyw = tex2D(_MainTex, u_xlat2.xy).xyz.xyz;
          u_xlat16_2 = dot(u_xlat10_2.xyw, float3(11.1999998, 8.39999962, 4.19999981));
          float _tmp_dvx_31 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_31, _tmp_dvx_31, _tmp_dvx_31);
          ...
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985)));
          float _tmp_dvx_32 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_32, _tmp_dvx_32, _tmp_dvx_32);
          ...
          u_xlat3.xyz = float3((u_xlat2.xxx + float3(0.25, 0, (-0.150000006))));
          u_xlat0_d.xyz = float3((((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + u_xlat3.xyz));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat6_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat12, u_xlat12, u_xlat12) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat12;
          u_xlat16_1.xyz = float3((u_xlat0_d.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xy = float2((in_f.texcoord.xy + float2(-0.0500000007, 0.0199999996)));
          u_xlat10_d = (((-u_xlat2_d.x) * 20) + 46.0999985);
          u_xlat10_d = sin(u_xlat10_d);
          u_xlat3.xyz = float3(((u_xlat2_d.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985)));
          u_xlat10_2.xyw = tex2D(_MainTex, u_xlat2_d.xy).xyz.xyz;
          u_xlat16_2 = dot(u_xlat10_2.xyw, float3(11.1999998, 8.39999962, 4.19999981));
          float _tmp_dvx_33 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_33, _tmp_dvx_33, _tmp_dvx_33);
          ...
          u_xlat6_d.x = sin(u_xlat6_d.x);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985)));
          float _tmp_dvx_34 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_34, _tmp_dvx_34, _tmp_dvx_34);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat6_d.x + 5);
          ...
          u_xlat3.xyz = float3((u_xlat2_d.xxx + float3(0.25, 0, (-0.150000006))));
          u_xlat0_d.xyz = float3((((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + u_xlat3.xyz));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat6_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat12, u_xlat12, u_xlat12) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat12;
          ...
          u_xlat16_1.xyz = float3((float3(u_xlat12, u_xlat12, u_xlat12) * _LightColor0.xyz));
          u_xlat16_1.xyz = float3((u_xlat0_d.xyz * u_xlat16_1.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_35 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_35, _tmp_dvx_35, _tmp_dvx_35);
          ...
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985)));
          float _tmp_dvx_36 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_36, _tmp_dvx_36, _tmp_dvx_36);
          ...
          u_xlat2.x = ((-u_xlat2.x) + 1);
          u_xlat6.xyz = float3((u_xlat10_0.xyz * in_f.texcoord2.xyz));
          ...
          u_xlat2.x = (((-u_xlat2.x) * 0.125) + u_xlat3.x);
          u_xlat3.xyz = float3((u_xlat2.xxx + float3(0.25, 0, (-0.150000006))));
          u_xlat0_d.xyz = float3((((-u_xlat10_0.xyz) * in_f.texcoord2.xyz) + u_xlat3.xyz));
          u_xlat0_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat6.xyz));
          ...
          u_xlat16_1_d.xyz = float3(max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_1_d.xyz = float3(log2(u_xlat16_1_d.xyz));
          u_xlat2.xyz = float3(((-u_xlat16_1_d.xyz) + in_f.texcoord5.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_2.xyw = tex2D(_MainTex, u_xlat2.xy).xyz.xyz;
          u_xlat16_2 = dot(u_xlat10_2.xyw, float3(11.1999998, 8.39999962, 4.19999981));
          float _tmp_dvx_37 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_37, _tmp_dvx_37, _tmp_dvx_37);
          u_xlat6_d.x = (u_xlat10 + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat6_d.x + 5);
          ...
          u_xlat6_d.x = sin(u_xlat6_d.x);
          u_xlat3.xyz = float3(((in_f.texcoord.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985)));
          float _tmp_dvx_38 = sin(u_xlat3.xyz);
          u_xlat3.xyz = float3(_tmp_dvx_38, _tmp_dvx_38, _tmp_dvx_38);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat6_d.x + 5);
