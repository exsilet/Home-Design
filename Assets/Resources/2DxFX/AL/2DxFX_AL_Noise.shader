  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = float3(((-u_xlat10_0.xyz) + float3(u_xlat12, u_xlat12, u_xlat12)));
          u_xlat1_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat3.xyz) + u_xlat10_0.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = float3(((-u_xlat10_0.xyz) + float3(u_xlat12_d, u_xlat12_d, u_xlat12_d)));
          u_xlat1_d.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat3.xyz) + u_xlat10_0.xyz));
