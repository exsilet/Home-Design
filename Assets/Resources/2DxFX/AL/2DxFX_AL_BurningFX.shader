  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3((u_xlat10_0.xyz * in_f.texcoord3.xyz));
          ...
          u_xlat3.xyz = float3(((u_xlat2.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727)));
          u_xlat2.x = (u_xlat2.x * _Distortion);
          u_xlat2.xw = (u_xlat2.xx * float2(2.4000001, 1.5999999));
          u_xlat2.xw = (u_xlat2.xw * u_xlat2.xw);
          u_xlat3.xyz = float3(((float3(u_xlat10, u_xlat10, u_xlat10) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat3.xyz));
          ...
          u_xlat2.xy = float2((u_xlat2.xw / float2(_Distortion, _Distortion)));
          u_xlat2.z = (u_xlat3.x * _Distortion);
          u_xlat0_d.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord3.xyz) + u_xlat2.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xyz = float3((u_xlat10_0.xyz * in_f.texcoord3.xyz));
          ...
          u_xlat3.xyz = float3(((u_xlat2_d.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727)));
          ...
          u_xlat3.xyz = float3(((float3(u_xlat10_d, u_xlat10_d, u_xlat10_d) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat3.xyz));
          u_xlat6_d.x = (u_xlat3.z / u_xlat6_d.x);
          ...
          u_xlat2_d.xy = float2((u_xlat2_d.xw / float2(_Distortion, _Distortion)));
          u_xlat2_d.z = (u_xlat3.x * _Distortion);
          u_xlat0_d.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord3.xyz) + u_xlat2_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat12, u_xlat12, u_xlat12) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat12;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3((u_xlat10_0.xyz * in_f.texcoord2.xyz));
          u_xlat2.x = dot(u_xlat2.xyz, float3(0.212599993, 0.715200007, 0.0722000003));
          ...
          u_xlat2.xy = float2((u_xlat2.xw / float2(_Distortion, _Distortion)));
          u_xlat2.z = (u_xlat3.x * _Distortion);
          u_xlat0_d.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord2.xyz) + u_xlat2.xyz));
