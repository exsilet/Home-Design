  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5.xy = float2((in_f.texcoord.xy + float2(-0.5, (-0.5))));
          u_xlat5.xy = float2((u_xlat5.xy * float2(1.24600005, 1.24600005)));
          u_xlat3.y = u_xlat2.x;
          ...
          u_xlat0_d.xy = float2((int(u_xlatb5))?(u_xlat2.xy):(u_xlat1_d.xy));
          u_xlat10.xy = float2((u_xlat1_d.xy + float2(0.5, 0.5)));
          u_xlat10.xy = float2(((-u_xlat10.xy) + float2(0.5, 0.5)));
          ...
          u_xlat5.xy = float2((u_xlat5.xy * float2(4, 6.66666651)));
          ...
          u_xlat1_d.xyz = float3((u_xlat10.xxx * u_xlat10_1.xyz));
          ...
          u_xlat5.xyz = float3((u_xlat0_d.xxx * u_xlat1_d.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((int(u_xlatb5))?(u_xlat2_d.xy):(u_xlat1_d.xy));
          u_xlat10_d.xy = float2((u_xlat1_d.xy + float2(0.5, 0.5)));
          u_xlat10_d.xy = float2(((-u_xlat10_d.xy) + float2(0.5, 0.5)));
          ...
          u_xlat1_d.xyz = float3((u_xlat10_d.xxx * u_xlat10_1.xyz));
          u_xlat16_4.x = ((u_xlat0_d.x * u_xlat5.x) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat5.x * u_xlat0_d.x);
          if((u_xlat16_4.x<0))
          {
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5.xy = float2((u_xlat5.xy * float2(6.66666651, 4)));
          u_xlat5.xy = float2(clamp(u_xlat5.xy, 0, 1));
          u_xlat15 = ((u_xlat5.x * (-2)) + 3);
          u_xlat5.x = (u_xlat5.x * u_xlat5.x);
          u_xlat5.x = (((-u_xlat15) * u_xlat5.x) + 1);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5.xy = float2((in_f.texcoord1.xy + float2(-0.5, (-0.5))));
          u_xlat5.xy = float2((u_xlat5.xy * float2(1.24600005, 1.24600005)));
