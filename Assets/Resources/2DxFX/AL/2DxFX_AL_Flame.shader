  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2(((float2(0, (-28.8000011)) * u_xlat0_d.xy) + in_f.texcoord.xy));
          u_xlat0_d.xy = float2((u_xlat0_d.yy * float2(128, (-19.2000008))));
          u_xlat1_d.z = (u_xlat1_d.y * 0.0833333358);
          u_xlat10_9 = tex2D(_MainTex2, u_xlat1_d.xz).y.x;
          u_xlat0_d.z = 0;
          u_xlat1_d.xy = float2((u_xlat0_d.zy + in_f.texcoord.xy));
          ...
          u_xlat10_6 = tex2D(_MainTex2, u_xlat1_d.xz).y.x;
          u_xlat16_6 = ((-u_xlat10_6) + u_xlat10_9);
          u_xlat6_d = ((u_xlat16_6 * _Intensity) + (-1));
          u_xlat6_d = (float(1) / u_xlat6_d);
          u_xlat1_d.xy = float2((in_f.texcoord.xy + float2(-0.5, (-1))));
          ...
          u_xlat3.xyz = float3(((u_xlat0_d.xxx * float3(0, 0, 0.600000024)) + float3(0, 1, 0)));
          u_xlat1_d.xy = float2((u_xlat0_d.xx * float2(0.625, 1.42857146)));
          u_xlat1_d.xy = float2(u_xlat1_d.xy);
          u_xlat1_d.xy = float2(clamp(u_xlat1_d.xy, 0, 1));
          u_xlat7.xy = float2(((u_xlat1_d.xy * float2(-2, (-2))) + float2(3, 3)));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * u_xlat1_d.xy));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * u_xlat7.xy));
          u_xlat3.xyz = float3(((u_xlat1_d.xxx * u_xlat3.xyz) + float3(1, 0, (-1))));
          u_xlat3.xyz = float3(((u_xlat1_d.yyy * u_xlat3.xyz) + float3(0, 0, 1)));
          u_xlat1_d.x = 1.20000005;
          u_xlat1_d.yz = in_f.texcoord3.yz;
          u_xlat3.xyz = float3((u_xlat3.xyz * u_xlat1_d.xyz));
          ...
          u_xlat0_d.xyz = float3((u_xlat3.xyz * u_xlat1_d.yxx));
          u_xlat1_d.z = 1.20000005;
          u_xlat0_d.xyz = float3((u_xlat0_d.xyz * u_xlat1_d.xzz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_2.xyz = float3((float3(u_xlat9, u_xlat9, u_xlat9) * _LightColor0.xyz));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = 1.5;
          u_xlat0_d.y = (_Time.x * _Speed);
          u_xlat1_d.xy = float2(((float2(0, (-28.8000011)) * u_xlat0_d.xy) + in_f.texcoord1.xy));
          u_xlat0_d.xy = float2((u_xlat0_d.yy * float2(128, (-19.2000008))));
          u_xlat1_d.z = (u_xlat1_d.y * 0.0833333358);
          u_xlat10_9 = tex2D(_MainTex2, u_xlat1_d.xz).y.x;
          u_xlat0_d.z = 0;
          u_xlat1_d.xy = float2((u_xlat0_d.zy + in_f.texcoord1.xy));
          u_xlat0_d.x = cos(u_xlat0_d.x);
          ...
          u_xlat6 = ((u_xlat16_6 * _Intensity) + (-1));
          u_xlat6 = (float(1) / u_xlat6);
          u_xlat1_d.xy = float2((in_f.texcoord1.xy + float2(-0.5, (-1))));
          u_xlat6 = (u_xlat6 * u_xlat1_d.y);
          u_xlat6 = clamp(u_xlat6, 0, 1);
