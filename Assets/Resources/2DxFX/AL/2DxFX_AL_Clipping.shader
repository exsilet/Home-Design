  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          if((in_f.texcoord.y<u_xlat0_d.x))
          {
              u_xlatb0 = 1;
          }
          else
          ...
          u_xlatb3.xy = float2(bool4(float4(_ClipUp, _ClipRight, _ClipUp, _ClipUp) < in_f.texcoord.yxyy).xy);
          u_xlatb0 = (u_xlatb0 || u_xlatb3.x);
          u_xlatb0 = (u_xlatb3.y || u_xlatb0);
          u_xlat3 = ((-_ClipLeft) + 1);
          if((in_f.texcoord.x<u_xlat3))
          {
              u_xlatb3.x = 1;
          }
          else
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb2.xy = float2(bool4(float4(_ClipUp, _ClipRight, _ClipUp, _ClipUp) < in_f.texcoord.yxyy).xy);
          u_xlatb0 = (u_xlatb0 || u_xlatb2.x);
          u_xlatb0 = (u_xlatb2.y || u_xlatb0);
          u_xlat2 = ((-_ClipLeft) + 1);
          if((in_f.texcoord.x<u_xlat2))
          {
              u_xlatb2.x = 1;
          }
          else
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb2.xy = float2(bool4(float4(_ClipUp, _ClipRight, _ClipUp, _ClipUp) < in_f.texcoord1.yxyy).xy);
          u_xlatb0 = (u_xlatb0 || u_xlatb2.x);
          u_xlatb0 = (u_xlatb2.y || u_xlatb0);
          u_xlat2_d = ((-_ClipLeft) + 1);
          if((in_f.texcoord1.x<u_xlat2_d))
          {
              u_xlatb2.x = 1;
          }
          else
