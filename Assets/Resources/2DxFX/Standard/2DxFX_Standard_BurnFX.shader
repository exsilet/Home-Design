  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xy = float2((in_f.texcoord.xy * float2(3.5, 3.5)));
          u_xlat2 = float(0);
          u_xlat7 = float(2);
          int u_xlati_loop_1 = 0;
          while((u_xlati_loop_1<9))
          {
              u_xlat12.xy = float2((u_xlat6.xy * float2(u_xlat7, u_xlat7)));
              u_xlat12.xy = float2(floor(u_xlat12.xy));
              u_xlat3.xy = float2(((float2(u_xlat7, u_xlat7) * u_xlat6.xy) + (-u_xlat12.xy)));
              u_xlat13.xy = float2((u_xlat3.xy * u_xlat3.xy));
              u_xlat3.xy = float2(((u_xlat3.xy * float2(-2, (-2))) + float2(3, 3)));
              u_xlat3.xy = float2((u_xlat3.xy * u_xlat13.xy));
              ...
              float _tmp_dvx_114 = sin(u_xlat4.xy);
              u_xlat4.xy = float2(_tmp_dvx_114, _tmp_dvx_114);
              ...
              u_xlat12.xy = float2((u_xlat12.xy + float2(1, 1)));
          ...
          u_xlat6.xyz = float3((u_xlat0_d.xyz * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d)));
          u_xlat0_d.xyz = float3(((u_xlat0_d.xyz * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d)) + (-float3(_Distortion, _Distortion, _Distortion))));
          ...
          u_xlat6.xy = float2((u_xlat6.yz * float2(u_xlat2, u_xlat2)));
          u_xlat6.xy = float2(((u_xlat6.xy * float2(10, 10)) + (-u_xlat0_d.yz)));
