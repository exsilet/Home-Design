  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_185 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_185, _tmp_dvx_185, _tmp_dvx_185, _tmp_dvx_185);
          ...
          u_xlat3.xyz = float3((u_xlat10_1.xyz * in_f.color.xyz));
          ...
          u_xlat1_d.xyz = float3(((u_xlat3.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727)));
          u_xlat2.xyz = float3((u_xlat3.xxx * float3(2.4000001, 1.5999999, 1.5999999)));
          u_xlat2.xyz = float3((u_xlat2.xyz * u_xlat2.xyz));
          u_xlat2.xyz = float3((u_xlat2.xyz * u_xlat2.xyz));
          u_xlat1_d.xyz = float3(((float3(u_xlat9, u_xlat9, u_xlat9) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat1_d.xyz));
          ...
          u_xlat1_d.y = 1;
          u_xlat3.xyz = float3((u_xlat1_d.xyz / float3(_Distortion, _Distortion, _Distortion)));
          u_xlat0_d.xyz = float3(((u_xlat3.xyz * u_xlat2.xyz) + u_xlat0_d.xxx));
          u_xlat1_d.xyz = float3(((u_xlat0_d.xyz * float3(0.5, 0.5, 0.5)) + float3(0.100000001, 0.100000001, 0.100000001)));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.215200007, 0.172199994));
          out_f.color.xyz = float3((u_xlat0_d.xxx + u_xlat1_d.xyz));
          return out_f;
      }
