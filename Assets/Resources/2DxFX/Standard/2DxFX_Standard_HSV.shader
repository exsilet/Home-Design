  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5.xy = float2(((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat2.yz)));
          ...
          u_xlat4.xyz = float3(((float3(float3(_Val, _Val, _Val)) * float3(0.587000012, 0.114, 0.298999995)) + (-u_xlat1_d.yzw)));
