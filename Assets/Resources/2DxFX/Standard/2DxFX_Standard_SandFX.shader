  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xy = float2((u_xlat3.xx * float2(41.9400024, 10.4666672)));
          float _tmp_dvx_115 = sin(u_xlat3.xy);
          u_xlat3.xy = float2(_tmp_dvx_115, _tmp_dvx_115);
          u_xlat3.xy = float2(((u_xlat3.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy));
          ...
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx + float3(0.5, 0.300000012, (-0.300000012))));
          u_xlat0_d.xyz = float3((((-u_xlat10_1.xyz) * in_f.color.xyz) + u_xlat0_d.xyz));
          out_f.color.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat2.xyz));
