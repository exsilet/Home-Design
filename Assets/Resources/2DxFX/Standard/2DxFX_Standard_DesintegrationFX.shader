  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11.xy = float2((in_f.texcoord.xy * float2(3.5, 3.5)));
          u_xlat2.x = float(0);
          u_xlat7 = float(2);
          int u_xlati_loop_1 = int(0);
          while((u_xlati_loop_1<9))
          {
              u_xlat3.xy = float2((u_xlat11.xy * float2(u_xlat7, u_xlat7)));
              u_xlat3.xy = float2(floor(u_xlat3.xy));
              u_xlat13.xy = float2(((float2(u_xlat7, u_xlat7) * u_xlat11.xy) + (-u_xlat3.xy)));
              u_xlat4.xy = float2((u_xlat13.xy * u_xlat13.xy));
              u_xlat13.xy = float2(((u_xlat13.xy * float2(-2, (-2))) + float2(3, 3)));
              u_xlat13.xy = float2((u_xlat13.xy * u_xlat4.xy));
              ...
              float _tmp_dvx_155 = sin(u_xlat4.xy);
              u_xlat4.xy = float2(_tmp_dvx_155, _tmp_dvx_155);
          ...
          u_xlat6.xyz = float3((u_xlat0_d.yzw * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d)));
          u_xlat2.x = (((-u_xlat0_d.x) * u_xlat1_d) + 1);
          u_xlat2.xyz = float3(((u_xlat6.xyz * u_xlat2.xxx) + _ColorX.xyz));
          u_xlat5.xyz = float3((((-u_xlat0_d.yzw) * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d)) + u_xlat2.xyz));
          out_f.color.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat5.xyz) + u_xlat6.xyz));
