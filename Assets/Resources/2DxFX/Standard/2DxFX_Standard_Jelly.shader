  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_142 = cos(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_142, _tmp_dvx_142);
          ...
          u_xlat8.xy = float2((u_xlat2.xy + float2(-0.5, (-0.5))));
          u_xlat8.xy = float2(((u_xlat8.xy * float2(float2(_Inside, _Inside))) + float2(0.5, 0.5)));
          ...
          u_xlat1_d.xyz = float3((u_xlat2.www * u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3(((u_xlat1_d.xyz * float3(-0.5, (-0.5), (-0.5))) + u_xlat0_d.xyz));
          u_xlat12 = ((-_Inside) + 3);
          u_xlat1_d.xyz = float3((u_xlat2.xyz / float3(u_xlat12, u_xlat12, u_xlat12)));
          out_f.color.xyz = float3(((u_xlat1_d.xyz * u_xlat2.www) + u_xlat0_d.xyz));
          return out_f;
      }
