    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          while((u_xlati_loop_1<9))
          {
              ...
              float _tmp_dvx_1 = sin(u_xlat4.xy);
          ...
          u_xlat5.xyz = float3((u_xlat0_d.yzw * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d)));
          ...
          u_xlat6.xy = float2((u_xlat5.yz * u_xlat11.xx));
          u_xlat6.xy = float2(((u_xlat6.xy * float2(40, 5)) + (-u_xlat5.yz)));
