  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_69 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_69, _tmp_dvx_69);
          ...
          float _tmp_dvx_70 = cos(u_xlat2.yzw);
          u_xlat7.xyz = float3(_tmp_dvx_70, _tmp_dvx_70, _tmp_dvx_70);
          ...
          float _tmp_dvx_71 = sin(u_xlat5.xy);
          u_xlat5.xy = float2(_tmp_dvx_71, _tmp_dvx_71);
          ...
          u_xlat10_10 = tex2D(_MainTex, in_f.texcoord.xy).w.x;
