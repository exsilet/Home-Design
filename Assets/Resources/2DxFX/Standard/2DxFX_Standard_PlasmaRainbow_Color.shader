  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_80 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_80, _tmp_dvx_80, _tmp_dvx_80, _tmp_dvx_80);
          ...
          u_xlat2.xyz = float3((((-u_xlat0_d.xxx) * float3(float3(_Colors, _Colors, _Colors))) + float3(2, 4, 6)));
          u_xlat2.xyz = float3(clamp(u_xlat2.xyz, 0, 1));
          u_xlat3.xy = float2(((u_xlat0_d.xx * float2(float2(_Colors, _Colors))) + float2(-4, (-2))));
          u_xlat3.xy = float2(clamp(u_xlat3.xy, 0, 1));
          u_xlat0_d.y = (u_xlatb4.x)?(u_xlat8):(u_xlat2.y);
          u_xlat0_d.z = (u_xlatb4.z)?(u_xlat3.y):(u_xlat2.z);
          u_xlat0_d.x = (u_xlat2.x + u_xlat3.x);
          u_xlat2.xyz = float3(((-u_xlat0_d.xyz) + u_xlat10_1.xyz));
          u_xlat16_3.xyz = float3((u_xlat10_1.xyz + u_xlat10_1.xyz));
          u_xlat0_d.xyz = float3(((u_xlat16_3.xyz * u_xlat2.xyz) + u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3((((-u_xlat10_1.xyz) * float3(0.5, 0.5, 0.5)) + u_xlat0_d.xyz));
