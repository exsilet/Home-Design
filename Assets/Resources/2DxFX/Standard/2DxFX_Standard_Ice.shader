  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb10.xy = float2(bool4(u_xlat2.xyxy >= (-u_xlat2.xyxy)).xy);
          ...
          u_xlat10.xy = float2(floor(u_xlat2.zw));
          ...
          out_f.color.xyz = float3(((u_xlat0_d.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat1_d.xyz));
