  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3((u_xlat1_d.xzw * float3(1.42857146, 4, 1.05263162)));
          u_xlat2.xyz = float3(clamp(u_xlat2.xyz, 0, 1));
          u_xlat3.xyz = float3(((u_xlat2.xyz * float3(-2, (-2), (-2))) + float3(3, 3, 3)));
          u_xlat2.xyz = float3((u_xlat2.xyz * u_xlat2.xyz));
          ...
          u_xlat6.xy = float2(((float2(u_xlat10_0, u_xlat10_0) * float2(0.300000012, 0.200000003)) + in_f.texcoord.xy));
          u_xlat10_6.xy = tex2D(_MainTex2, u_xlat6.xy).xz.xy;
          u_xlat12 = (((-u_xlat3.z) * u_xlat2.z) + u_xlat10_6.y);
          u_xlat16_3.xyz = float3(((u_xlat10_6.xxx * float3(0.300000012, 0.5, 1)) + float3(0.200000003, 0.300000012, 0.600000024)));
          u_xlat3.xyz = float3((u_xlat16_3.xyz * TeleportationColor.xyz));
          ...
          u_xlat10_18 = tex2D(_MainTex2, u_xlat1_d.xw).y.x;
          ...
          u_xlat6.xy = float2((u_xlat6.xy * float2(0.847457647, 9.99999809)));
          u_xlat6.xy = float2(clamp(u_xlat6.xy, 0, 1));
          u_xlat13.xy = float2(((u_xlat6.xy * float2(-2, (-2))) + float2(3, 3)));
          u_xlat6.xy = float2((u_xlat6.xy * u_xlat6.xy));
          u_xlat6.xy = float2((u_xlat6.xy * u_xlat13.xy));
          ...
          u_xlat1_d.xyz = float3(((u_xlat2.yyy * u_xlat2.xzw) + u_xlat1_d.xzw));
          u_xlat2.xyz = float3(((-u_xlat1_d.xyz) + float3(1.64999998, 1.64999998, 1.64999998)));
          u_xlat6.xyz = float3(((u_xlat6.xxx * u_xlat2.xyz) + u_xlat1_d.xyz));
          out_f.color.xyz = float3((u_xlat0_d.xxx * u_xlat6.xyz));
          return out_f;
      }
