  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xy = float2((u_xlat1_d.xy * float2(0.333333343, 0.333333343)));
          u_xlat10_3.xyz = tex2D(_MainTex2, u_xlat3.xy).xyz.xyz;
          u_xlat1_d.x = (TurnToLiquid * 20);
          u_xlat3.xyz = float3((u_xlat10_3.xyz * u_xlat1_d.xxx));
          u_xlat1_d.xy = float2(((u_xlat3.xy * float2(0.0625, 0.0625)) + u_xlat1_d.zw));
          ...
          u_xlat4.xyz = float3(((float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * float3(0.5, 0.5, 0.5)) + u_xlat2.xyz));
          u_xlat0_d = (u_xlat1_d.x * u_xlat2.w);
          out_f.color.xyz = float3(((u_xlat3.xyz * float3(0.125, 0.125, 0.125)) + u_xlat4.xyz));
          u_xlat3.x = ((-_Alpha) + 1);
