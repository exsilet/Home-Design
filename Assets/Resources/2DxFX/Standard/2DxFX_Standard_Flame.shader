  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat1_d.xz).y.x;
          ...
          u_xlat2.xyz = float3(((u_xlat0_d.xxx * float3(0, 0, 0.600000024)) + float3(0, 1, 0)));
          ...
          u_xlat5.xy = float2(((u_xlat1_d.xy * float2(-2, (-2))) + float2(3, 3)));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * u_xlat1_d.xy));
          u_xlat1_d.xy = float2((u_xlat1_d.xy * u_xlat5.xy));
          u_xlat2.xyz = float3(((u_xlat1_d.xxx * u_xlat2.xyz) + float3(1, 0, (-1))));
          u_xlat2.xyz = float3(((u_xlat1_d.yyy * u_xlat2.xyz) + float3(0, 0, 1)));
          u_xlat1_d.x = 1.20000005;
          u_xlat1_d.yz = in_f.color.yz;
          u_xlat1_d.xyz = float3((u_xlat2.xyz * u_xlat1_d.xyz));
