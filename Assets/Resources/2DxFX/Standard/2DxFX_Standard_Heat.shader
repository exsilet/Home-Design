  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = float2(((u_xlat0_d.xx * float2(140, 8)) + in_f.texcoord.yy));
          float _tmp_dvx_0 = sin(u_xlat2.xy);
          u_xlat2.yz = float2(_tmp_dvx_0, _tmp_dvx_0);
          u_xlat2.x = cos(u_xlat2.x);
          u_xlat2.xy = float2((u_xlat2.xy * float2(_Distortion, _Distortion)));
