  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1 = tex2Dlod(_MainTex, float4(float3(u_xlat0_d.zw, 0), 0));
          u_xlat10_0 = tex2Dlod(_MainTex, float4(float3(u_xlat0_d.xy, 0), 0));
          ...
          u_xlat10_3 = tex2Dlod(_MainTex, float4(float3(u_xlat2.zw, 0), 0));
          u_xlat10_2 = tex2Dlod(_MainTex, float4(float3(u_xlat2.xy, 0), 0));
          ...
          u_xlat10_5 = tex2Dlod(_MainTex, float4(float3(u_xlat4.zw, 0), 0));
          u_xlat10_4 = tex2Dlod(_MainTex, float4(float3(u_xlat4.xy, 0), 0));
          ...
          u_xlat10_7 = tex2Dlod(_MainTex, float4(float3(u_xlat6.zw, 0), 0));
          u_xlat10_6 = tex2Dlod(_MainTex, float4(float3(u_xlat6.xy, 0), 0));
          ...
          u_xlat10_9 = tex2Dlod(_MainTex, float4(float3(u_xlat8.zw, 0), 0));
          u_xlat10_8 = tex2Dlod(_MainTex, float4(float3(u_xlat8.xy, 0), 0));
          u_xlat10_10 = tex2Dlod(_MainTex, float4(float3(in_f.texcoord.xy, 0), 0));
          ...
          u_xlat10_3 = tex2Dlod(_MainTex, float4(float3(u_xlat1_d.xy, 0), 0));
          u_xlat10_1 = tex2Dlod(_MainTex, float4(float3(u_xlat1_d.zw, 0), 0));
          ...
          u_xlat2 = (u_xlat2 * float4(0.00390625, 0.00390625, 0.00390625, 0.00390625));
          u_xlat10_3 = tex2Dlod(_MainTex, float4(float3(u_xlat2.xy, 0), 0));
          u_xlat10_2 = tex2Dlod(_MainTex, float4(float3(u_xlat2.zw, 0), 0));
          ...
          u_xlat10_12 = tex2Dlod(_MainTex, float4(float3(u_xlat11.zw, 0), 0));
          u_xlat10_11 = tex2Dlod(_MainTex, float4(float3(u_xlat11.xy, 0), 0));
          ...
          u_xlat10_13 = tex2Dlod(_MainTex, float4(float3(u_xlat12.xy, 0), 0));
          u_xlat10_12 = tex2Dlod(_MainTex, float4(float3(u_xlat12.zw, 0), 0));
          ...
          u_xlat16_3.xyz = float3((u_xlat10_2.xyz + u_xlat10_3.xyz));
          ...
          u_xlat16_14.xyz = float3((u_xlat10_8.xyz + u_xlat16_3.xyz));
          u_xlat16_14.xyz = float3((u_xlat10_9.xyz + u_xlat16_14.xyz));
          u_xlat16_14.xyz = float3((u_xlat10_10.xyz + u_xlat16_14.xyz));
          out_f.color.w = (u_xlat10_10.w + (-_Alpha));
          u_xlat16_14.xyz = float3((u_xlat10_6.xyz + u_xlat16_14.xyz));
          u_xlat16_14.xyz = float3((u_xlat10_7.xyz + u_xlat16_14.xyz));
          u_xlat16_14.xyz = float3((u_xlat10_4.xyz + u_xlat16_14.xyz));
          u_xlat16_14.xyz = float3((u_xlat10_5.xyz + u_xlat16_14.xyz));
          u_xlat14.xyz = float3((u_xlat16_14.xyz * in_f.color.xyz));
          u_xlat14.xyz = float3((u_xlat14.xyz * float3(0.777777791, 0.777777791, 0.777777791)));
          u_xlat14.xyz = float3(floor(u_xlat14.xyz));
          u_xlat14.xyz = float3((u_xlat14.xyz / float3(_ColorLevel, _ColorLevel, _ColorLevel)));
          u_xlat1_d.x = (_EdgeSize + 0.0500000007);
          if((u_xlat1_d.x<u_xlat0_d.x))
          {
              u_xlatb0 = 1;
          }
          else
          ...
          out_f.color.xyz = float3((int(u_xlatb0))?(float3(0, 0, 0)):(u_xlat14.xyz));
          return out_f;
      }
