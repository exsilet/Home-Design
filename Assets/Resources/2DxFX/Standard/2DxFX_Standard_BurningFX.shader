  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xyz = float3((u_xlat10_0.xyz * in_f.color.xyz));
          ...
          u_xlat2.xyz = float3(((u_xlat1_d.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727)));
          ...
          u_xlat2.xyz = float3(((float3(u_xlat7, u_xlat7, u_xlat7) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat2.xyz));
          ...
          u_xlat1_d.xy = float2((u_xlat1_d.xw / float2(_Distortion, _Distortion)));
          u_xlat1_d.z = (u_xlat2.x * _Distortion);
          out_f.color.xyz = float3(((u_xlat10_0.xyz * in_f.color.xyz) + u_xlat1_d.xyz));
