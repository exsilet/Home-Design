  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_184 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_184, _tmp_dvx_184, _tmp_dvx_184, _tmp_dvx_184);
          ...
          u_xlat16_2.xy = float2((u_xlat16_2.xy * u_xlat16_2.xy));
          u_xlat16_1.xyz = float3(((float3(u_xlat16_9, u_xlat16_9, u_xlat16_9) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat16_1.xyz));
          ...
          u_xlat4.xy = float2((u_xlat0_d.wz * u_xlat3.xx));
          u_xlat3.xy = float2((u_xlat4.xy / float2(_Distortion, _Distortion)));
