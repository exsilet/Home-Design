  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb5.xy = float2(bool4(u_xlat0_d.xxxx >= float4(0.5, 0.600000024, 0, 0)).xy);
          ...
          u_xlat0_d.x = (u_xlat5.x * u_xlat0_d.x);
          u_xlat5.xy = float2(((in_f.texcoord.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat2.x = _Time.y;
          u_xlat3.x = sin(_Time.y);
          u_xlat4.x = cos(_Time.y);
          u_xlat2.y = (u_xlat4.x * _Time.y);
          u_xlat5.xy = float2(((u_xlat2.xy * float2(1.60000002, 1.60000002)) + u_xlat5.xy));
          ...
          float _tmp_dvx_165 = cos(u_xlat1_d.yz);
          u_xlat1_d.xy = float2(_tmp_dvx_165, _tmp_dvx_165);
          ...
          float _tmp_dvx_166 = cos(u_xlat2.yzw);
          u_xlat7.xyz = float3(_tmp_dvx_166, _tmp_dvx_166, _tmp_dvx_166);
          ...
          float _tmp_dvx_167 = sin(u_xlat5.xy);
          u_xlat5.xy = float2(_tmp_dvx_167, _tmp_dvx_167);
          u_xlat10 = ((u_xlat5.y * 0.300000012) + 3);
          if((u_xlat5.x>=0.899999976))
          {
              u_xlatb5.x = 1;
          }
          else
          ...
          u_xlat1_d.xy = float2((u_xlatb5.x)?(float2(-0.0500000007, (-0))):(float2(0, (-0))));
          ...
          u_xlat0_d.xy = float2((((-u_xlat0_d.xy) * float2(u_xlat10, u_xlat10)) + float2(1, 1)));
          u_xlat0_d.x = (u_xlat0_d.y * u_xlat0_d.x);
          u_xlat1_d.x = (u_xlat0_d.x * u_xlat1_d.x);
          u_xlat5.xy = float2((in_f.texcoord.xy * _Time.yy));
          ...
          out_f.color.xyz = float3(u_xlat1_d.xyz);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat5.x);
