  ...
  SubShader
  {
    ...
    Pass // ind: 2, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat1.xyz = float3((u_xlat0.xyw * float3(0.5, 0.5, 0.5)));
          u_xlat1.xy = float2((u_xlat1.zz + u_xlat1.xy));
          out_v.texcoord1.xy = float2((u_xlat1.xy / u_xlat0.ww));
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = float3((u_xlat0_d.xxx * float3(6, 8, 4)));
          ...
          u_xlat0_d.xy = float2(((u_xlat10_1.ww * u_xlat10_1.xx) + u_xlat0_d.xy));
          ...
          u_xlat10_0.xzw = tex2D(_GrabTexture, u_xlat0_d.xz).xyz.xyz;
          ...
          u_xlat6.xyz = float3((u_xlat10_1.xyz * float3(Light, Light, Light)));
          u_xlat6.xyz = float3((u_xlat6.xyz * Lightcolor.xyz));
          u_xlat2.xyz = float3(((u_xlat2.xxx * Lightcolor.xyz) + u_xlat6.xyz));
          u_xlat2.xyz = float3((float3(u_xlat16_4, u_xlat16_4, u_xlat16_4) + u_xlat2.xyz));
          u_xlat3.xyz = float3((Lightcolor.xyz * Lightcolor.www));
          u_xlat0_d.xyz = float3(((u_xlat10_0.xzw * in_f.color.xyz) + u_xlat3.xyz));
          u_xlat0_d.xyz = float3(((u_xlat2.xyz * float3(float3(EValue, EValue, EValue))) + u_xlat0_d.xyz));
          out_f.color.xyz = float3(((u_xlat10_1.xxx * float3(TValue, TValue, TValue)) + u_xlat0_d.xyz));
