  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((u_xlat2.xx / u_xlat4.xy));
          if((in_f.texcoord.y<u_xlat4.y))
          {
              u_xlatb4 = 1;
          }
          else
          ...
          u_xlat5.xy = float2(((-in_f.texcoord.yx) + float2(1, 1)));
          ...
          u_xlat2.xy = float2((u_xlat2.xx / u_xlat4.xy));
          if((in_f.texcoord.x<u_xlat4.y))
          {
              u_xlatb6 = 1;
          }
          else
