  ...
  SubShader
  {
    ...
    Pass // ind: 2, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xyz = float3(in_f.color.xyz);
          ...
          u_xlat14.xy = float2((in_f.texcoord1.xy + float2(8.52999973, 8.52999973)));
          u_xlat3.x = float(0);
          ...
          u_xlat8.xy = float2((u_xlat3.xy + (-in_f.texcoord1.xy)));
          u_xlat2.xy = float2(((u_xlat2.xx * u_xlat8.xy) + in_f.texcoord1.xy));
          ...
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * u_xlat1_d.xyz));
          out_f.color.xyz = float3(((u_xlat0_d.xyz * float3(2, 2, 2)) + u_xlat2.xyz));
