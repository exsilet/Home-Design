  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3((((-u_xlat10_1.xyz) * in_f.color.xyz) + float3(1, 0, 0)));
          u_xlat3 = (u_xlat10_1 * in_f.color);
          u_xlat2.xyz = float3(((float3(_Value4, _Value4, _Value4) * u_xlat2.xyz) + u_xlat3.xyz));
          u_xlat4.xyz = float3(((u_xlat10_1.xyz * in_f.color.xyz) + (-u_xlat2.xyz)));
          u_xlat5.xyz = float3(((u_xlat5.xxx * u_xlat4.xyz) + u_xlat2.xyz));
          u_xlat2.xyz = float3(((u_xlat10_1.xyz * in_f.color.xyz) + (-u_xlat5.xyz)));
          u_xlat3.xyz = float3(((float3(float3(_Value1, _Value1, _Value1)) * u_xlat2.xyz) + u_xlat5.xyz));
          u_xlat5.x = ((-_Value5) + 1);
          u_xlat2.w = (-u_xlat5.x);
