Shader "2DxFX/Standard/Pixel"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = float2((in_f.texcoord.xy * float2(_Offset, _Offset)));
          u_xlat0_d.xy = float2(round(u_xlat0_d.xy));
          u_xlat0_d.xy = float2((u_xlat0_d.xy / float2(_Offset, _Offset)));
