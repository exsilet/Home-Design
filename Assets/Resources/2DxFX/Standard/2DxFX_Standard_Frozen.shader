  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10.xy = float2(((in_f.texcoord.xy * float2(u_xlat5, u_xlat5)) + u_xlat0_d.xx));
          u_xlat0_d.xy = float2(((u_xlat10.xy * float2(u_xlat5, u_xlat5)) + u_xlat0_d.xx));
          ...
          u_xlat3.xy = float2((((-float2(u_xlat16, u_xlat16)) * u_xlat16_3.xy) + float2(1, 1)));
          ...
          u_xlat4.xy = float2((float2(u_xlat13, u_xlat13) * u_xlat16_4.xy));
          u_xlat13 = (u_xlat10_10 * u_xlat13);
          u_xlat4.xy = float2((int(u_xlatb15))?(u_xlat4.xy):(u_xlat3.xy));
          ...
          u_xlat3.y = 0;
          u_xlat3.xy = float2((u_xlat3.xy + in_f.texcoord.xy));
          u_xlat3.xy = float2((float2(u_xlat10_10, u_xlat10_10) + u_xlat3.xy));
          u_xlat10_10 = tex2D(_MainTex2, u_xlat3.xy).y.x;
          u_xlat0_d.xyz = float3(((float3(u_xlat10_10, u_xlat10_10, u_xlat10_10) * float3(0.5, 0.5, 0.5)) + u_xlat0_d.xyw));
          u_xlat0_d.xyz = float3((((-u_xlat10_1.xyz) * in_f.color.xyz) + u_xlat0_d.xyz));
          out_f.color.xyz = float3(((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xyz) + u_xlat2.xyz));
