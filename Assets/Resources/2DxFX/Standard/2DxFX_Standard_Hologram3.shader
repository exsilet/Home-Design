  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xy = float2((in_f.texcoord.xy + float2(-0.5, (-0.5))));
          u_xlat1_d.xy = float2((u_xlat6.xy * u_xlat6.xy));
          u_xlat6.xy = float2((u_xlat6.yx * float2(4.19999981, 4.19999981)));
          u_xlat18 = dot(u_xlat1_d.yy, u_xlat1_d.xx);
          u_xlat18 = (u_xlat18 + 0.238095239);
          u_xlat1_d.xy = float2(((u_xlat6.yx * float2(u_xlat18, u_xlat18)) + float2(0.5, 0.5)));
          u_xlat6.xy = float2((float2(u_xlat18, u_xlat18) * u_xlat6.xy));
          u_xlat6.xy = float2((u_xlat6.xy * u_xlat6.xy));
          ...
          float _tmp_dvx_2 = cos(u_xlat2.yzw);
          u_xlat2.xyz = float3(_tmp_dvx_2, _tmp_dvx_2, _tmp_dvx_2);
          ...
          float _tmp_dvx_3 = cos(u_xlat4.zw);
          u_xlat0_d.xw = float2(_tmp_dvx_3, _tmp_dvx_3);
          float _tmp_dvx_4 = sin(u_xlat4.xy);
          u_xlat8.xy = float2(_tmp_dvx_4, _tmp_dvx_4);
          u_xlat0_d.x = ((u_xlat0_d.x * 2) + _Time.y);
          u_xlat0_d.w = ((u_xlat0_d.w * 5) + _Time.y);
          float _tmp_dvx_5 = sin(u_xlat0_d.xw);
          u_xlat0_d.xw = float2(_tmp_dvx_5, _tmp_dvx_5);
          u_xlat18 = ((u_xlat0_d.w * 0.300000012) + 3);
          u_xlat6.xy = float2((((-u_xlat6.xy) * float2(u_xlat18, u_xlat18)) + float2(1, 1)));
          ...
          u_xlat12.xy = float2(((u_xlat1_d.xy * float2(0.5, 1)) + float2(6, 3)));
          u_xlat4.x = _Time.y;
          u_xlat12.xy = float2(((u_xlat4.xy * float2(1.60000002, 1.60000002)) + u_xlat12.xy));
          u_xlat14.xy = float2((u_xlat4.xy * float2(1.60000002, 1.60000002)));
          u_xlat14.xy = float2(((u_xlat1_d.xy * float2(2, 2)) + u_xlat14.xy));
