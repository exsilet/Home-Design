  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2((u_xlat0_d.xx * in_f.texcoord.xy));
          ...
          float _tmp_dvx_6 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_6, _tmp_dvx_6, _tmp_dvx_6, _tmp_dvx_6);
          ...
          u_xlat2.xyz = float3(((-u_xlat10_1.xyz) + u_xlat2.xxx));
          u_xlat2.xyz = float3(((float3(_Distortion, _Distortion, _Distortion) * u_xlat2.xyz) + u_xlat10_1.xyz));
          u_xlat0_d.xyz = float3(((u_xlat0_d.xxx * float3(_Distortion, _Distortion, _Distortion)) + u_xlat2.xyz));
