  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xy = float2((in_f.texcoord.xy * float2(0.125, 0.125)));
          ...
          u_xlat3 = (((-u_xlat3) * 0.125) + u_xlat6.y);
          u_xlat2.y = (u_xlat3 + 1);
          u_xlat10_2.xyz = tex2D(_MainTex2, u_xlat2.xy).xyz.xyz;
          u_xlat16_1.xyz = float3((u_xlat10_1.xyz + u_xlat10_2.xyz));
          if((u_xlat0_d.x>=(-u_xlat0_d.x)))
          {
              u_xlatb3 = 1;
          }
          ...
          u_xlat10_0.xyz = tex2D(_MainTex2, u_xlat2.xy).xyz.xyz;
          u_xlat16_0.xyz = float3((u_xlat10_0.xyz + u_xlat16_1.xyz));
