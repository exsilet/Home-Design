  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2(((float2(u_xlat14, u_xlat14) * float2(6.23489809, (-2.22520947))) + u_xlat0_d.xx));
          u_xlat21 = (u_xlat1_d.x + in_f.texcoord.x);
          u_xlat1_d.x = (u_xlat1_d.y + u_xlat21);
          u_xlat15 = (u_xlat1_d.x * (-0.222520947));
          u_xlat2.xy = float2(((float2(u_xlat14, u_xlat14) * float2(7.81831503, 9.74927902)) + (-u_xlat0_d.xx)));
          ...
          u_xlat3.xy = float2(((float2(u_xlat14, u_xlat14) * float2(-9.00968933, (-9.00968838))) + u_xlat0_d.xx));
          u_xlat16 = (u_xlat1_d.x + u_xlat3.x);
          u_xlat17 = (u_xlat16 * (-0.900968909));
          u_xlat4.xy = float2(((float2(u_xlat14, u_xlat14) * float2(4.33883619, (-4.33883762))) + (-u_xlat0_d.xx)));
          ...
          u_xlat18.xy = float2(((float2(u_xlat14, u_xlat14) * float2(-9.74927902, (-7.81831312))) + (-u_xlat0_d.xx)));
          u_xlat23 = (u_xlat23 + (-u_xlat18.x));
          u_xlat5.xy = float2(((float2(u_xlat14, u_xlat14) * float2(-2.22521019, 6.23490047)) + u_xlat0_d.xx));
          ...
          u_xlat8.xy = float2((u_xlat8.xz * float2(6, 6)));
          float _tmp_dvx_126 = cos(u_xlat8.xy);
          u_xlat8.xy = float2(_tmp_dvx_126, _tmp_dvx_126);
          ...
          u_xlat8.xy = float2((u_xlat8.xy * float2(6, 6)));
          float _tmp_dvx_127 = cos(u_xlat8.xy);
          u_xlat8.xy = float2(_tmp_dvx_127, _tmp_dvx_127);
          ...
          float _tmp_dvx_128 = cos(u_xlat0_d.xz);
          u_xlat0_d.xz = float2(_tmp_dvx_128, _tmp_dvx_128);
          ...
          u_xlat8.xy = float2((u_xlat2.xy + (-in_f.texcoord.xy)));
          u_xlat8.xy = float2(((float2(float2(EValue, EValue)) * u_xlat8.xy) + in_f.texcoord.xy));
