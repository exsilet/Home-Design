  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.xy = float2((in_f.texcoord.xy + float2(-0.5, (-0.5))));
          u_xlat4.xy = float2((u_xlat4.xy * float2(1.24600005, 1.24600005)));
          u_xlat3.y = u_xlat2.x;
          ...
          u_xlat0_d.xy = float2((int(u_xlatb4))?(u_xlat2.xy):(u_xlat1_d.xy));
          u_xlat8.xy = float2((u_xlat1_d.xy + float2(0.5, 0.5)));
          u_xlat8.xy = float2(((-u_xlat8.xy) + float2(0.5, 0.5)));
          ...
          u_xlat4.xy = float2((u_xlat4.xy * float2(4, 6.66666651)));
          ...
          u_xlat1_d.xyz = float3((u_xlat8.xxx * u_xlat10_1.xyz));
