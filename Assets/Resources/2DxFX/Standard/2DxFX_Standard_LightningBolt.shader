  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat8.xy = float2((in_f.texcoord.xy * float2(0.125, 0.125)));
          ...
          u_xlat0_d.xy = float2((_Time.xx + float2(0.200000003, 0.800000012)));
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(float2(_Value1, _Value1))));
          u_xlatb2.xy = float2(bool4(u_xlat0_d.xyxx >= (-u_xlat0_d.xyxx)).xy);
          u_xlat10.xy = float2(frac(abs(u_xlat0_d.xy)));
          u_xlat0_d.xy = float2((u_xlat0_d.xy * float2(0.125, 0.125)));
          ...
          u_xlat2.xy = float2(((u_xlat2.xy * float2(0.125, 0.125)) + u_xlat8.xx));
          u_xlatb3.xy = float2(bool4(u_xlat0_d.xyxx >= (-u_xlat0_d.xyxx)).xy);
          u_xlat0_d.xy = float2(frac(abs(u_xlat0_d.xy)));
          ...
          u_xlat0_d.xy = float2((((-u_xlat0_d.xy) * float2(0.125, 0.125)) + u_xlat8.yy));
          u_xlat2.zw = (u_xlat0_d.xy + float2(1, 1));
          u_xlat10_0.xyz = tex2D(_MainTex2, u_xlat2.xz).xyz.xyz;
          u_xlat10_2.xyz = tex2D(_MainTex2, u_xlat2.yw).xyz.xyz;
          u_xlat16_0.xyz = float3((u_xlat10_0.xyz + u_xlat10_1.xyz));
          u_xlat16_0.xyz = float3((u_xlat10_2.xyz + u_xlat16_0.xyz));
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.color);
          out_f.color.xyz = float3(((u_xlat16_0.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat1_d.xyz));
