  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_164 = sin(u_xlat0_d);
          u_xlat0_d = float4(_tmp_dvx_164, _tmp_dvx_164, _tmp_dvx_164, _tmp_dvx_164);
          ...
          out_f.color.xyz = float3(((u_xlat3.xyz * u_xlat2.xyz) + u_xlat0_d.xxx));
          return out_f;
      }
