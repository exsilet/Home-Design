  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.xy = float2(((float2(u_xlat10_0, u_xlat10_0) * float2(0.300000012, 0.200000003)) + in_f.texcoord.xy));
          u_xlat10_4 = tex2D(_MainTex2, u_xlat4.xy).z.x;
          ...
          u_xlat10_12 = tex2D(_MainTex2, u_xlat1_d.xw).y.x;
          ...
          u_xlat4.xy = float2((u_xlat4.xy * float2(0.847457647, 9.99999809)));
          u_xlat4.xy = float2(clamp(u_xlat4.xy, 0, 1));
          u_xlat9.xy = float2(((u_xlat4.xy * float2(-2, (-2))) + float2(3, 3)));
          u_xlat4.xy = float2((u_xlat4.xy * u_xlat4.xy));
          u_xlat4.xy = float2((u_xlat4.xy * u_xlat9.xy));
          ...
          u_xlat4.xyz = float3(((u_xlat4.xxx * u_xlat2.xyz) + u_xlat1_d.xyz));
          out_f.color.xyz = float3((u_xlat0_d.xxx * u_xlat4.xyz));
          return out_f;
      }
