  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          if((abs(u_xlat0_d.y)<abs(u_xlat0_d.x)))
          {
              u_xlatb3 = 1;
          }
          else
          ...
          u_xlat0_d.xyz = float3(((u_xlat0_d.xxx * float3(_ShinyFX_Intensity_1, _ShinyFX_Intensity_1, _ShinyFX_Intensity_1)) + u_xlat10_1.xyz));
