  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.xy = float2(((float2(float2(_ColorHSV_Brightness_1, _ColorHSV_Brightness_1)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw));
          u_xlat1_d.xy = float2(((float2(float2(_ColorHSV_Brightness_1, _ColorHSV_Brightness_1)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz)));
          ...
          u_xlat2.xyz = float3(((float3(float3(_ColorHSV_Brightness_1, _ColorHSV_Brightness_1, _ColorHSV_Brightness_1)) * float3(0.587000012, 0.114, 0.298999995)) + (-u_xlat2.yzw)));
          ...
          out_f.color.xyz = float3((u_xlat1_d.xyz * in_f.color.xyz));
          return out_f;
      }
