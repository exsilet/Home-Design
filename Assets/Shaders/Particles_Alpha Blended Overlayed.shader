Shader "Particles/Alpha Blended Overlayed"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat16_0.xyz = float3((((-in_f.color.xyz) * _TintColor.xyz) + float3(1, 1, 1)));
          ...
          u_xlat16_0.xyz = float3((((-u_xlat16_0.xyz) * u_xlat16_2.xyz) + float3(1, 1, 1)));
          ...
          u_xlat16_2.xyz = float3((u_xlat16_2.yzw * u_xlat16_3.xyz));
          out_f.color.w = (u_xlat10_1.w * u_xlat16_3.w);
          out_f.color.xyz = float3((int(u_xlatb1))?(u_xlat16_0.xyz):(u_xlat16_2.xyz));
          return out_f;
      }
